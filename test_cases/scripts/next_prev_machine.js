...
const nextMachine = {
    nextMachine: 'button[class="fc-next-button btn btn-primary"]',
};

const previousMachine = {
    previousMachine: 'button[class="fc-prev-button btn btn-primary"]',
};
...
//   await page.select("select#searchMachines");

  await page.click(nextMachine.nextMachine);
  await delay(10000);

  await page.click(previousMachine.previousMachine);
  await delay(10000);
