...
puppeteer.launch(config.launchOptions).then(async (browser) => {
  ...
  // **Anlagengruppe**
  await page.select("select#select_group_options", "6");
  await delay(15000);

  // **Tables**
  await page.select("select#select_group_table", "data_channel_15m");
  await delay(15000);
  ...
  // **Foreign Key**
  await page.select("select#foreign_key_subGroup", "data_channel_15m_id");
  await delay(15000);
