...
<nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
      ...
      <div class="navbar-menu-wrapper d-flex align-items-center justify-content-end act_background">
        ...
        <ul class="navbar-nav mr-lg-2 menu_dashboard_ul">
          ...
          <li><a href="#" class="text-muted menu_dashboard font-weight-bold">Dashboard</a></li>
          ...
          <li><a href="#" class="text-muted menu_dashboard font-weight-bold"><img src="images/logout2.png"></a></li>
        </ul>
