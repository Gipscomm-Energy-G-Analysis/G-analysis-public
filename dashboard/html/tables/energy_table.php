                      ...
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group col-md-3">
                              <div class="form-check form-check-primary">
                                ...
                                Erweiterte Ansicht anwenden
                                  <input type="checkbox" class="text-mute form-check-input" id="expand_view_energy_table" name="expand_view" value="0">  
                          ...
                          <diV class="form-group col-md-2">
                            <div class="form-check form-check-primary">
                              <label class="form-check-label">
                                ...
                                <input type="checkbox" class="text-mute form-check-input" id="energy_table_outside_tile_structure" name="table_outside_tile_structure" value="0">  
                              </label>
                            </div>
                          </div>
                          <!-- -end -->
                          ...
                          <div class="form-group col-md-2 table_outisde_tile_controls" style="display: none">
                            ...
                            <input type="number" class="form-control form-control-sm text-dark" id="energy_table_height_outer_structure" placeholder="Outer Column">
                          </div>

                          <div class="form-group col-md-2 table_outisde_tile_controls"  style="display: none">
                            <label for="table_width_outer_structure" class="text-mute">Außerhalb der Kachelreihe</label>
                            <input type="number" class="form-control form-control-sm text-dark" id="energy_table_width_outer_structure" placeholder="Outer Row">
                          </div>

                          <div class="form-group col-md-2 table_outisde_tile_controls" style="display: none">
                            <label for="table_outer_table_limit_column" class="text-mute">Spaltenlimit</label>
                            <input type="number" class="form-control form-control-sm text-dark" id="energy_table_outer_table_limit_column" placeholder="Limit Column" value='1'>
                          </div>
                          </div>
                          <!-- -end- -->
                          <!-- 23-8-21 -->
