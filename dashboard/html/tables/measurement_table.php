                ...
                <div class="card-body">
                  ...
                  <div class="row">
                    ...
                    <!-- <div class="form-group col-md-2" style="display: none">
                      ...
                      <div class="form-group col-md-3">
                      <input type="button" class="btn btn-sm btn-success click_common_btn" id="measurement_btn_table" value='Show Results'>
                      ...
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group col-md-3">
                              <div class="form-check form-check-primary">
                                ...
                                Erweiterte Ansicht anwenden
                                  <input type="checkbox" class="text-mute form-check-input" id="expand_view_table" name="expand_view" value="0">  
                          ...
                          <diV class="form-group col-md-2">
                            <div class="form-check form-check-primary">
                              <label class="form-check-label">
                                ...
                                <input type="checkbox" class="text-mute form-check-input" id="table_outside_tile_structure" name="table_outside_tile_structure" value="0">  
                              </label>
                            </div>
                          </div>
                          <!-- -end -->
                          ...
                          <div class="form-group col-md-2 table_outisde_tile_controls" style="display: none">
                            ...
                            <input type="number" class="form-control form-control-sm text-dark" id="table_height_outer_structure" placeholder="Outer Column">
                          </div>

                          <div class="form-group col-md-2 table_outisde_tile_controls"  style="display: none">
                            <label for="table_width_outer_structure" class="text-mute">Außerhalb der Kachelreihe</label>
                            <input type="number" class="form-control form-control-sm text-dark" id="table_width_outer_structure" placeholder="Outer Row">
                          </div>

                          <div class="form-group col-md-2 table_outisde_tile_controls" style="display: none">
                            <label for="table_outer_table_limit_column" class="text-mute">Spaltenlimit</label>
                            <input type="number" class="form-control form-control-sm text-dark" id="table_outer_table_limit_column" placeholder="Limit Column" value='1'>
                          </div>
                          </div>
                          <!-- -end- -->
                          <!-- 23-8-21 -->
                          <div class="row dashboard_modal_tile gernerated_measurement_modal_tiles">
                          </div>
                          <!-- --end-- -->
                          <div class="row dashboard_modal_tile">
                            <div class="grid-margin actual_tile_height actual_tile_width stretch-card " id="measurement_count_tile_modal" style="display: none">
                              <div class="card card-border">
                                <div class="card-body overflow-hide display-flex">
                                  <div id="" class="">
                                      <p class="card-title text-md-center text-xl-left" id="measurement_tile_heading_modal"></p>
