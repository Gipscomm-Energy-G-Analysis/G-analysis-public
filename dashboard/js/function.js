...
function getTableFormatDashboard(typeval){
  ...
  $.ajax({
      ...
      if(a['data'] != '' && a['data'] != null && (!a['data']['error'])){
        ...
        a['data'].forEach(value => {
          ...
          // <---18-09-2023--
            ...
            // <---18-09-2023--  //Height Add Class in Overflow
            if(input_height <=2){
    ...
    //},1000);
        ...
        // $('#dashboard_count_div_tile .stretch-card').css('width',250);
...
////get save graph dashboard listing 2024
...
//////end get saved graph dashboard listing
             ...
             if(type=='week2'){
              ...
              if(type=='custom2'){
                ...
                function loadSortedSeries(id) {
                  ...
                  let series = chart.model.series;
                  // Sort the series by the length of their dataSource (x-axis length)
                  let sortedSeries = series.sort(function(a, b) {console.log("a.dataSource.length",a.dataSource.length);
                      return b.dataSource.length - a.dataSource.length; // Descending order
                  });
                  // Clear the existing series in the chart
                  chart.model.series = [];
    ...
    $.ajax({
      ...
      success: function(a) {
        if((a[0]['type']=='Measurement') && (a[0]['tile_record_type']=='measurement')){
          ...
          //var tile_data_type =a[0]['tile_data_type'];
