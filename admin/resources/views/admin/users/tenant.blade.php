...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0">{{ __('tenant-group.mainHeading') }}</h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item"><a href="{{route('dashboard')}}">{{ __('tenant-group.breadcrumb') }}</a></li>
                    <li class="breadcrumb-item active">{{ __('tenant-group.subBreadcrumb') }}</li>
                </ol>
            </div><!-- /.col -->
        </div><!-- /.row -->
    </div><!-- /.container-fluid -->
...
<section class="main-sec-admin">
    ...
    <div class="row">
        <div class="container-fluid">
            ...
            <form action="{{route('tenant-group-form')}}" method="post" id="tenant-form">
                @csrf
                        ...
                        <div class="main-box-blade p-3">
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" rows="3" placeholder="{{ __('tenant-group.note') }}" name="note"></textarea>
                                </div>
                            </div>
                            ...
                            <a href="{{route('tenant-group-list')}}"><button type="button" class="btn btn-default mr-2">{{ __('tenant-group.cancel') }}</button></a>
                                <button type="submit" class="btn btn-secondary save-tenant-group float-right">{{ __('tenant-group.submit') }}</button>
                            </div>
                        </div>
            </form>
        </div>
