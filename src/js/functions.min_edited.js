...
$jscomp.polyfill("Promise", function(a) {
    ...
    c.prototype.then = function(a, b) {
        ...
        var g, f, h = new c(function(a, b) {
            g = a;
            f = b
        }
        );
        this.callWhenSettled_(e(a, g), e(b, f));
        return h
    }
    ;
    ...
    c.race = function(a) {
        return new c(function(b, e) {
            for (var g = $jscomp.makeIterator(a), f = g.next(); !f.done; f = g.next())
                c.resolve(f.value).callWhenSettled_(b, e)
        }
        )
    }
    ;
    c.all = function(a) {
        var b = $jscomp.makeIterator(a)
          , e = b.next();
        return e.done ? c.resolve([]) : new c(function(a, g) {
            function f(b) {
                return function(c) {
                    h[b] = c;
                    q--;
            ...
            do
                h.push(void 0),
                q++,
                c.resolve(e.value).callWhenSettled_(f(h.length - 1), g),
                e = b.next();
            while (!e.done)
        }
        )
...
var d = new Date
  , cont2 = "";
processLoginInfo();
var tblInstanzMstSuchen = $("#tblInstanzMstSuchen").DataTable({
    dom: "Bfrtip",
    buttons: [],
    pageLength: 15,
    bAutoWidth: !1,
...
spiesOrganisationenSearch1 = $("#spiesOrganisationenSearch").DataTable({
    dom: "Bfrtip",
    buttons: [{
        extend: "copy",
        text: "Kopieren",
...
function mainMenuNav(a) {
    "menuBerechnungsformeln" == a || "menuProduktionAusw" == a || "spaEfVTab1Menu" == a || "spaEfVTab2Menu" == a || "verbExportMenu" == a || "mstVerglMenu" == a || "zeitVerglMenu" == a || "knzDarst" == a || "menuVorlagenformeln" == a ? ($("#tabsAuswertungen, #auswertungen").css("display", "block"),
    $("#tabsOptionen, #interneMesswerte").css("display", "none"),
    "menuBerechnungsformeln" == a || "menuVorlagenformeln" == a ? ($("#editor, #tabProd").css("display", "block"),
    "menuBerechnungsformeln" == a ? tabControlNav("tabBerechnungsformeln") : "menuVorlagenformeln" == a && tabControlNav("tabVorlagenformeln")) : $("#editor, #tabBerechnungsformeln, #tabVorlagenformeln").css("display", "none"),
    "menuProduktionAusw" == a ? ($("#produktion, #tabProd").css("display", "block"),
    tabControlNav("tabProd")) : $("#produktion, #tabProd").css("display", "none"),
    "verbExportMenu" == a ? ($("#datenexport, #tabVerbrauchsdatenExp").css("display", "block"),
    tabControlNav("tabVerbrauchsdatenExp")) : $("#datenexport, #tabVerbrauchsdatenExp").css("display", "none"),
    "mstVerglMenu" == a || "zeitVerglMenu" == a || "knzDarst" == a ? ($("#diagramme, #tabLnDiag, #tabTimeCompDiag, #tabDiagKnz").css("display", "block"),
    "mstVerglMenu" == a ? tabControlNav("tabLnDiag") : "zeitVerglMenu" == a ? tabControlNav("tabTimeCompDiag") : "knzDarst" == a && tabControlNav("tabDiagKnz")) : $("#diagramme, #tabLnDiag, #tabTimeCompDiag, #tabDiagKnz").css("display", "none"),
    "spaEfVTab1Menu" == a || "spaEfVTab2Menu" == a ? ($("#berichte, #tabSpaEfV_Tbl1, #tabSpaEfV_Tbl2").css("display", "block"),
    "spaEfVTab1Menu" == a ? (tabControlNav("tabSpaEfV_Tbl1"),
    $("#verwaltung").val("ausw")) : "spaEfVTab2Menu" == a && (tabControlNav("tabSpaEfV_Tbl2"),
    $("#verwaltung").val("ausw"))) : $("#berichte, #tabSpaEfV_Tbl1, #tabSpaEfV_Tbl2").css("display", "none")) : $("#tabsAuswertungen, #auswertungen").css("display", "none");
    "betrGrpMenu" == a || "manGrpMenu" == a || "sAdmMenu" == a || "admMenu" == a || "benMenu" == a ? ($("#tabsOptionen, #tabsEditor, #tabsAuswertungen").css("display", "none"),
    $("#tabsRechteverwaltung, #rechteverwaltung, #stammdaten").css("display", "block"),
    "betrGrpMenu" == a ? tabControlNav("tabBetrGrp") : "manGrpMenu" == a ? tabControlNav("tabManGrp") : "sAdmMenu" == a ? tabControlNav("tabSAdm") : "admMenu" == a ? tabControlNav("tabAdm") : "benMenu" == a && tabControlNav("tabBen")) : $("#tabsRechteverwaltung, #rechteverwaltung").css("display", "none");
    "untMenu" == a || "manMenu" == a || "orgMenu" == a || "liegMenu" == a || "berMenu" == a || "stdMenu" == a || "stdDrMenu" == a ? ($("#tabsOptionen, #tabsEditor, #tabsAuswertungen").css("display", "none"),
    $("#tabsUnternehmensstruktur, #unternehmensstruktur, #stammdaten").css("display", "block"),
    "untMenu" == a || "manMenu" == a ? tabControlNav("tabMan") : "orgMenu" == a ? tabControlNav("tabOrg") : "liegMenu" == a ? tabControlNav("tabLieg") : "berMenu" == a ? (energietrInDBoxBer(),
    tabControlNav("tabBer")) : "stdMenu" == a ? tabControlNav("tabStd") : "stdDrMenu" == a && tabControlNav("tabStdDr")) : $("#tabsUnternehmensstruktur, #unternehmensstruktur").css("display", "none");
    if ("anlMenu" == a || "anl_Eng_Menu" == a || "anl_Dok_Menu" == a || "anl_Hist_Menu" == a || "anl_Konfig_Menu" == a || "anl_Menu" == a) {
    ...
    "msmMenu" == a ? ($("#tabsEditor").css("display", "none"),
    $("#tabsMessmittelverwaltung, #messmittelverwaltung, #stammdaten").css("display", "block"),
    tabControlNav("tabMsm"),
    $("#verwaltung").val("Msm")) : $("#tabsMessmittelverwaltung, #messmittelverwaltung").css("display", "none");
    if ("prdMenu" == a || "prd_Menu" == a || "prd_Konfig_Menu" == a || "prd_Hist_Menu" == a) {
        ...
        $("#tabsProdukteverwaltung, #produkteverwaltung").css("display", "none");
    "knz_almMenu" == a || "knzMenu" == a || "almMenu" == a ? ($("#tabsEditor").css("display", "none"),
    $("#tabsKennzahlenAlarme, #kennzahlenAlarme, #stammdaten").css("display", "block"),
    "knz_almMenu" == a || "knzMenu" == a ? (erweiterungenProdukteEinlesen(),
    tabControlNav("tabKnz")) : "almMenu" == a && tabControlNav("tabAlm")) : $("#tabsKennzahlenAlarme, #kennzahlenAlarme").css("display", "none");
    "erwPrdMenu" == a || "erwAnlMenu" == a || "entMenu" == a || "enfMenu" == a || "gsfMenu" == a || "mgsMenu" == a || "zpMenu" == a || "grpDiagMenu" == a ? ($("#tabsOptionen, #optionen").css("display", "block"),
    $("#tabsUnternehmensstruktur, #tabsEditor").css("display", "none"),
    $("#tabsBasisdaten").css("display", "block"),
    "entMenu" == a || "enfMenu" == a ? tabControlNav("tabEng") : "gsfMenu" == a ? tabControlNav("tabGsf") : "mgsMenu" == a ? tabControlNav("tabMgs") : "zpMenu" == a ? tabControlNav("tabZp") : "erwAnlMenu" == a ? tabControlNav("tabEAnl") : "erwPrdMenu" == a && tabControlNav("tabEPrd")) : "grpDiagMenu" == a ? tabControlNav("tabGrpDiag") : $("#tabsOptionen, #optionen").css("display", "none");
    "intEngIMwMenu" == a || "intBdeIMwMenu" == a || "extRngMenu" == a || "eRngVergleichMenu" == a ? ($("#tabsEditor").css("display", "none"),
    $("#tabsManuell").css("display", "block"),
    "intEngIMwMenu" == a || "intBdeIMwMenu" == a ? ($("#tabsIntMesswerte").css("display", "block"),
    "intEngIMwMenu" == a ? (tabControlNav("tabIntEnergiedatenIMw"),
    $("#verwaltung").val("intEngIMw")) : "intBdeIMwMenu" == a && (tabControlNav("tabIntBetriebsdatenIMw"),
    $("#verwaltung").val("intBdeIMw"))) : $("#tabsIntMesswerte").css("display", "none"),
    "extRngMenu" == a || "eRngVergleichMenu" == a ? ($("#tabsEditor").css("display", "none"),
    $("#tabsExterneRechnungen").css("display", "block"),
    "extRngMenu" == a ? (tabControlNav("tabExtRechnungen"),
    $("#verwaltung").val("ERng")) : "eRngVergleichMenu" == a && (tabControlNav("tabAusw_eRng_iMw"),
    $("#verwaltung").val("AusERng"))) : $("#tabsExterneRechnungen").css("display", "none")) : $("#tabsManuell").css("display", "none")
}
function tabControlNav(a) {
    var b = [];
    ...
    for (var e = 0; e < nTabsData; e++)
        if (a == tabsData[e].tab && "" != tabsData[e].info) {
            ...
            if ("tabGipscAdm" == a)
                ...
                $("#asideRight2").css("display", "block"),
                knzEinheitenEinlesen();
            else if ("tabExtRechnungen" == a)
                $("#asideRight").css("display", "block"),
                versorgerUndEinheitBefuellen(),
                energietrInDBoxERngVergleich(),
                energietrInDBoxLieg();
            else if ("tabAusw_eRng_iMw" == a)
                energietrInDBoxERngVergleich(),
                energietrInDBoxLieg(),
                externeRechnungenListeErstellen("vergleich");
            else if ("tabIntEnergiedatenIMw" == a || "tabIntBetriebsdatenIMw" == a)
                $("#berechnungsformelnLeft").css("display", "none"),
                $("#interneMesswerteLeft, #interneMesswerte").css("display", "block"),
                $("#infosMasseneingabe").css("display", "none"),
                $("#btnMassEingAnl, #btnMassEingMst").text("Masseneingabe"),
            ...
            else if ("tabBerechnungsformeln" == a || "tabVorlagenformeln" == a)
                $("#tabsAuswertungen").css("display", "block"),
                $("#tabBerechnungsformeln, #tabVorlagenformeln").css("display", "inline-block"),
                $("#asideLeft").css("display", "block"),
                $("#berechnungsformelnLeft").css("display", "block"),
                $("#interneMesswerteLeft").css("display", "none"),
                $("#formelStringDarstellung").val(""),
                $("#formelIdDarstellung").val(""),
                $("#berechneteMstName").val(""),
                messstellenInAuswertungsEditorTabelleEinlesen(),
                anlagenInAuswertungsEditorTabelleEinlesen(),
                dynBdeDatenInAuswertungsEditorTabelleEinlesen(),
                produkteInFormeleditorEinlesen();
            1 > tabsData[e].lengthPath ? alert("The tabsData[tb].lengthPath is to small! It has to be at least 1. :tabControlNav(tab)") : 4 < tabsData[e].lengthPath && alert("The tabsData[tb].lengthPath is to big! It has to be smaller than 4. :tabControlNav(tab)");
            lastNav.setBasicNavInfo(b, tabsData[e].aktivInstance);
            changeTracker.setInstance(tabsData[e].aktivInstance)
        } else
            $("#" + tabsData[e].tab).css("background-color", "#B9C0C7"),
            $("#" + tabsData[e].infos).css("display", "none"),
            "block" != $("#infosKennzahlen").css("display") && $("#asideRight2").css("display", "none"),
            "block" != $("#infosExtRechnungen").css("display") && $("#asideRight").css("display", "none"),
            "block" != $("#infosBerechnungsformeln").css("display") && "block" != $("#infosVorlagenformeln").css("display") && "block" != $("#infosIntEnergiedaten").css("display") && "block" != $("#infosIntBetriebsdaten").css("display") && $("#asideLeft").css("display", "none")
}
function instanzErstellen(a, b) {
    if ("gipscAdmSpeichern" == a)
        $.ajax({
            type: "POST",
            async: !0,
        ...
        for (i = 0; i < $("#tblMandantengruppe tbody tr").length; i++)
            e[i] = tblMandantengruppe.cell(i, 0).data();
        e = e.join(",");
        $.ajax({
            type: "POST",
            async: !0,
        ...
        var c;
        "optMan" == $("#manOderManGrp").val() ? (e = "man_ID",
        c = $("#manRechteID").val()) : (e = "manGrp_ID",
        c = $("#manGrpID").val());
        $.ajax({
            type: "POST",
            async: !0,
        ...
        e = $("#bildAllgemeinAnl").prop("src"),
        e = e.split($("#nameDB").val()),
        $.ajax({
            type: "POST",
            async: !0,
            url: "../php/instanzIntoDb.php",
    ...
    else if ("msmSpeichern" == a)
        e = $("#bildAllgemeinMsm").prop("src"),
        e = e.split($("#nameDB").val()),
        $.ajax({
            type: "POST",
            async: !0,
            ...
            data: {
                ...
                messmittelbild: "uploadsDownloads/images/" + $("#nameDB").val() + e[1],
        ...
        e = 0,
        e = "neueGrp" === b ? Number($("#prdCount").val()) + 1 : $("#gruppenIDPrd").val(),
        $.ajax({
            type: "POST",
            async: !0,
            url: "../php/instanzIntoDb.php",
        ...
        e = [];
        for (i = 0; i < $("#tblOptionenEAnl tbody tr").length; i++)
            e[i] = tblOptionenEAnl.cell(i, 0).data();
        e = e.join(",");
        $.ajax({
            type: "POST",
            async: !0,
        ...
        e = [];
        for (i = 0; i < $("#tblOptionenEPrd tbody tr").length; i++)
            e[i] = tblOptionenEPrd.cell(i, 0).data();
        e = e.join(",");
        $.ajax({
            type: "POST",
            async: !0,
        ...
        zpNavID = $("#zpCount").val()) : "betrParSpeichern" == a && (e = [],
        0 < $("#checkEPrd").length && (e = JSON.stringify(Array.from($("#checkEPrd div")).map(function(a) {
            return {
...
function instanzSpeichern(a) {
    if ("gipscAdmSpeichern" == a)
        ...
        for (i = 0; i < $("#tblMandantengruppe tbody tr").length; i++)
            (void 0)[i] = tblMandantengruppe.cell(i, 0).data();
        var b = (void 0).join(",");
        $.ajax({
            type: "POST",
            async: !0,
        ...
        for (var c = $("#bildAllgemeinAnl").prop("src"), g = c.split($("#nameDB").val()), f = changeTracker.getChanges(), h = f.length, q = "", r = 0; r < h; r++)
            q += f[r].label + ":" + f[r].oldValue + " -> " + f[r].newValue + ", ";
        $.ajax({
            type: "POST",
            async: !0,
            url: "php/instanzIntoDb.php",
    ...
    else if ("anlSpeichernHist" == a)
        c = $("#bildAllgemeinAnl").prop("src"),
        g = c.split($("#nameDB").val()),
        $.ajax({
            type: "POST",
            async: !0,
            url: "../php/instanzIntoDb.php",
        ...
        var x = ""
          , u = "INSERT INTO ";
        $("#zeitintervallMst").val() == TimeInterval.DAY ? x = "masseneingabeTage" : $("#zeitintervallMst").val() == TimeInterval.WEEK ? x = "masseneingabeWochen" : $("#zeitintervallMst").val() == TimeInterval.MONTH ? x = "masseneingabeMonate" : $("#zeitintervallMst").val() == TimeInterval.YEAR && (x = "masseneingabeJahre");
        ...
        $("#zeitintervallAnl").val() == TimeInterval.YEAR ? (u += t + " (anl_ID, engOderBde, einheit) ",
        u += "VALUES ( " + $("#anlID").val() + ", " + InstanceMode.BDE + ", '" + $("#einheitMasseneingabeIMw").val() + "') ") : (u += t + " (anl_ID, engOderBde, einheit, year) ",
        u += "VALUES ( " + $("#anlID").val() + ", " + InstanceMode.BDE + ", '" + $("#einheitMasseneingabeIMw").val() + "', '" + $("#jahrMassEingDataAnl").val() + "') ");
        (new DataMachine).runQuery("write", $("#nameDB").val(), u);
        $.ajax({
            type: "POST",
            async: !0,
        ...
        var w = [];
        for (i = 0; i < $("#tblOptionenEAnl tbody tr").length; i++)
            w[i] = tblOptionenEAnl.cell(i, 0).data();
        var y = w.join(",");
        $.ajax({
            type: "POST",
            async: !0,
        ...
        w = [];
        for (i = 0; i < $("#tblOptionenEPrd tbody tr").length; i++)
            w[i] = tblOptionenEPrd.cell(i, 0).data();
        y = w.join(",");
        $.ajax({
            type: "POST",
            async: !0,
...
function readInstanzen(a, b, e) {
    ...
    case "gipscAdm":
        $.ajax({
            ...
            success: function(a) {
                a = json(a);
                0 < a.length ? ($("#gipscAdmCount").val(a.length),
                $("#gipscAdmID").val(a[b].gipsAdm_ID),
                $("#benutzernameGipscAdm").val(a[b].username)) : clearFields("gipscAdm")
            }
        });
        break;
    case "betrGrp":
        $.ajax({
            ...
            success: function(a) {
                var c = json(a);
                0 < c.length ? ($("#betrGrpCount").val(c.length),[["#betrGrpID", "betrGrp_ID"]["#firmaBetrGrp","firma"]["#anzahlMitarbeiterBetrGrp","anzahlMitarbeiter"]["#anschriftBetrGrp",
                "anschrift"]["#plzBetrGrp",
                "plz"]["#ortBetrGrp",
                "ort"]["#geschaeftsfuehrerBetrGrp",
                "geschaeftsfuehrer"]["#telefonBetrGrp",
                "telefon"]["#emailBetrGrp",
                "eMail"]["#notizBetrGrp",
                "notiz"]].forEach(function(a) {
                    $(a[0]).val(c[b][a[1]])
                })) : clearFields("betrGrp")
            }
        });
    ...
    case "sAdm":
        $.ajax({
            ...
            success: function(a) {
                a = json(a);
                0 < a.length ? ($("#sAdmCount").val(a.length),
                $("#sAdmID").val(a[b].sAdm_ID),
                $("#titelSAdm").val(a[b].titelSAdm),
                $("#nameSAdm").val(a[b].nameSAdm),
                $("#vornameSAdm").val(a[b].vornameSAdm),
                $("#emailSAdm").val(a[b].emailSAdm),
                $("#telefonSAdm").val(a[b].telefonSAdm),
                $("#faxSAdm").val(a[b].faxSAdm),
                $("#mobiltelefonSAdm").val(a[b].mobiltelefonSAdm),
    ...
    case "manGrp":
        $.ajax({
            ...
            success: function(a) {
                var c = json(a);
                0 < c.length ? (mandantenInMandantenGruppenTabelleEinlesen(c[b].mandantenIDs),
                $("#manGrpCount").val(c.length),
                [["#manGrpID", "manGrp_ID"]["#nameManGrp",
                "name"]["#kurzManGrp",
                "kurz"]["#notizManGrp",
                "notiz"]].forEach(function(a) {
                    $(a[0]).val(c[b][a[1]])
        ...
        break;
    case "adm":
        "optMan" == $("#manOderManGrp").val() ? (a = "man_ID",
        e = $("#manRechteID").val()) : (a = "manGrp_ID",
        e = $("#manGrpID").val());
        $.ajax({
            type: "POST",
            async: !0,
            ...
            success: function(a) {
                ...
                [["#admID", "adm_ID"], ["#titelAdm", "titel"], ["#nameAdm", "name"], ["#vornameAdm", "vorname"], ["#emailAdm", "email"], ["#telefonAdm", "telefon"], ["#faxAdm", "fax"], ["#mobiltelefonAdm", "mobiltelefon"], ["#benutzernameAdm", "benutzername"]].forEach(function(a) {
                    $(a[0]).val(c[b][a[1]])
                })) : clearFields("admHinz")
            }
        });
    ...
    case "ben":
        ...
        $.ajax({
            ...
            success: function(a) {
                ...
                [["#benID", "ben_ID"], ["#titelBen", "titel"], ["#nameBen", "name"], ["#vornameBen", "vorname"], ["#emailBen", "eMail"], ["#telefonBen", "telefon"], ["#faxBen", "fax"], ["#mobiltelefonBen", "mobiltelefon"], ["#benutzernameBen", "benutzername"]].forEach(function(a) {
                    $(a[0]).val(c[b][a[1]])
                })) : clearFields("benHinz")
            }
        });
    ...
    case "org":
        $.ajax({
            ...
            success: function(a) {
                ...
                1 == c.length ? $(".orgPfad, .orgPfadLbl").css("display", "none") : $(".orgPfad, .orgPfadLbl").css("display", "inline");
                0 < c.length ? [["#orgID", "org_ID"], ["#nameAllgemeinOrg", "nameOrg"], ["#gesellschaftsformAllgemeinOrg", "gesellschaftsformOrg"], ["#firmenanschriftAllgemeinOrg", "anschriftOrg"], ["#landAllgemeinOrg", "landOrg"], ["#plzAllgemeinOrg", "plzOrg"], ["#ortAllgemeinOrg", "ortOrg"], ["#hrbnummerAllgemeinOrg", "hrbNummerOrg"], ["#titelGeschaeftsfuehrungOrg", "titelGeschaeftsfuehrungOrg"], ["#nameGeschaeftsfuehrungOrg", "nameGeschaeftsfuehrungOrg"], ["#vornameGeschaeftsfuehrungOrg", "vornameGeschaeftsfuehrungOrg"], ["#emailGeschaeftsfuehrungOrg", "eMailGeschaeftsfuehrungOrg"], ["#telefonGeschaeftsfuehrungOrg", "telefonGeschaeftsfuehrungOrg"], ["#faxGeschaeftsfuehrungOrg", "faxGeschaeftsfuehrungOrg"], ["#mobiltelefonGeschaeftsfuehrungOrg", "mobiltelefonGeschaeftsfuehrungOrg"], ["#titelEnergiemanagementOrg", "titelEnergiemanagementOrg"], ["#nameEnergiemanagementOrg", "nameEnergiemanagementOrg"], ["#vornameEnergiemanagementOrg", "vornameEnergiemanagementOrg"], ["#emailEnergiemanagementOrg", "eMailEnergiemanagementOrg"], ["#telefonEnergiemanagementOrg", "telefonEnergiemanagementOrg"], ["#faxEnergiemanagementOrg", "faxEnergiemanagementOrg"], [".orgPfad", "nameOrg"], ["#mobiltelefonEnergiemanagementOrg", "mobiltelefonEnergiemanagementOrg"]].forEach(function(a) {
                    $(a[0]).val(c[b][a[1]])
                }) : clearFields("orgHinz")
            }
        });
    ...
    case "lieg":
        $.ajax({
            ...
            success: function(a) {
                ...
                0 < c.length ? ($("#eigenstaendigeformAllgemeinLieg").prop("checked", c[b].eigenstaendigeFormLieg),
                $("#aktivAllgemeinLieg").prop("checked", c[b].aktivLieg),
                $("#hatDlAllgemeinLieg").prop("checked", c[b].hatDl),
                [["#liegID", "lieg_ID"], ["#nameAllgemeinLieg", "nameLieg"], ["#kuerzelAllgemeinLieg", "kuerzelLieg"], ["#gesellschaftsformAllgemeinLieg", "gesellschaftsformLieg"], ["#anschriftAllgemeinLieg", "anschriftLieg"], ["#landAllgemeinLieg", "landLieg"], ["#plzAllgemeinLieg", "plzLieg"], ["#ortAllgemeinLieg", "ortLieg"], ["#typAllgemeinLieg", "typLieg"], ["#titelAnsprechpartnerLieg", "titelAnsprechpartnerLieg"], ["#nameAnsprechpartnerLieg", "nameAnsprechpartnerLieg"], ["#vornameAnsprechpartnerLieg", "vornameAnsprechpartnerLieg"], ["#emailAnsprechpartnerLieg", "eMailAnsprechpartnerLieg"], ["#telefonAnsprechpartnerLieg", "telefonAnsprechpartnerLieg"], ["#faxAnsprechpartnerLieg", "faxAnsprechpartnerLieg"], ["#mobiltelefonAnsprechpartnerLieg", "mobiltelefonAnsprechpartnerLieg"], ["#titelEnergiebeauftragterLieg", "titelEnergiebeauftragterLieg"], ["#nameEnergiebeauftragterLieg", "nameEnergiebeauftragterLieg"], ["#vornameEnergiebeauftragterLieg", "vornameEnergiebeauftragterLieg"], ["#emailEnergiebeauftragterLieg", "eMailEnergiebeauftragterLieg"], ["#telefonEnergiebeauftragterLieg", "telefonEnergiebeauftragterLieg"], ["#faxEnergiebeauftragterLieg", "faxEnergiebeauftragterLieg"], ["#mobiltelefonEnergiebeauftragterLieg", "mobiltelefonEnergiebeauftragterLieg"], ["#inputEnergietraeger1Lieg", "energietraeger1"], ["#inputEnergietraeger2Lieg", "energietraeger2"], ["#inputEnergietraeger3Lieg", "energietraeger3"], ["#inputEnergietraeger4Lieg", "energietraeger4"], ["#inputEnergietraeger5Lieg", "energietraeger5"], ["#inputEnergietraeger6Lieg", "energietraeger6"], ["#inputEnergietraeger7Lieg", "energietraeger7"], ["#inputEnergietraeger8Lieg", "energietraeger8"], ["#inputEnergietraeger9Lieg", "energietraeger9"], ["#energieform1Lieg", "energieform1"], ["#energieform2Lieg", "energieform2"], ["#energieform3Lieg", "energieform3"], ["#energieform4Lieg", "energieform4"], ["#energieform5Lieg", "energieform5"], ["#energieform6Lieg", "energieform6"], ["#energieform7Lieg", "energieform7"], ["#managementsystem1Lieg", "managementsystem1"], ["#erstzertifizierung1Lieg", "erstzertifizierung1"], ["#managementsystem2Lieg", "managementsystem2"], ["#erstzertifizierung2Lieg", "erstzertifizierung2"], ["#managementsystem3Lieg", "managementsystem3"], ["#erstzertifizierung3Lieg", "erstzertifizierung3"]].forEach(function(a) {
                    $(a[0]).val(c[b][a[1]])
                }),
                toggleExtDl("#hatDlAllgemeinLieg"),
                "" != $("#inputEnergietraeger7Lieg").val() ? $("#entLiegErweitert").css("display", "block") : $("#entLiegErweitert").css("display", "none"),
                energietrInDBoxLieg(),
                $(".liegPfad").val(c[b].nameLieg)) : clearFields("liegHinz")
            }
        });
    ...
    case "extDl":
        $.ajax({
            ...
            success: function(a) {
                ...
                0 < c.length ? ($("#stdExtDl").prop("checked", c[b].standortdatenDritte),
                toggleStandorteDritter("#stdExtDl"),
                $("#aktivExtDl").prop("checked", c[b].aktivExtDl),
                [["#extDlID", "extDl_ID"], ["#nameExtDl", "nameExtDl"], ["#gesellschaftsformExtDl", "gesellschaftsformExtDl"], ["#anschriftExtDl", "anschriftExtDl"], ["#landExtDl", "landExtDl"], ["#plzExtDl", "plzExtDl"], ["#ortExtDl", "ortExtDl"], ["#typExtDl", "typExtDl"], ["#titelAnsprechpartnerExtDl", "titelAnsprechpartnerExtDl"], ["#nameAnsprechpartnerExtDl", "nameAnsprechpartnerExtDl"], ["#vornameAnsprechpartnerExtDl", "vornameAnsprechpartnerExtDl"], ["#emailAnsprechpartnerExtDl", "eMailAnsprechpartnerExtDl"], ["#telefonAnsprechpartnerExtDl", "telefonAnsprechpartnerExtDl"], ["#faxAnsprechpartnerExtDl", "faxAnsprechpartnerExtDl"], ["#mobiltelefonAnsprechpartnerExtDl", "mobiltelefonAnsprechpartnerExtDl"], ["#energietraeger1ExtDl", "energietraeger1"], ["#messstelle1ExtDl", "messstelle1ExtDl"], ["#standort1ExtDl", "standort1ExtDl"], ["#energietraeger2ExtDl", "energietraeger2"], ["#messstelle2ExtDl", "messstelle2ExtDl"], ["#standort2ExtDl", "standort2ExtDl"], ["#energietraeger3ExtDl", "energietraeger3"], ["#messstelle3ExtDl", "messstelle3ExtDl"], ["#standort3ExtDl", "standort3ExtDl"], ["#energietraeger4ExtDl", "energietraeger4"], ["#messstelle4ExtDl", "messstelle4ExtDl"], ["#standort4ExtDl", "standort4ExtDl"], ["#energietraeger5ExtDl", "energietraeger5"], ["#messstelle5ExtDl", "messstelle5ExtDl"], ["#standort5ExtDl", "standort5ExtDl"], ["#energietraeger6ExtDl", "energietraeger6"], ["#messstelle6ExtDl", "messstelle6ExtDl"], ["#standort6ExtDl", "standort6ExtDl"], ["#energieRes1ExtDl", "energieRes1ExtDl"], ["#messstelleEngRes1ExtDl", "messstelleEngRes1ExtDl"], ["#standort1EngResExtDl", "standortEngRes1ExtDl"], ["#energieRes2ExtDl", "energieRes2ExtDl"], ["#messstelleEngRes2ExtDl", "messstelleEngRes2ExtDl"], ["#standort2EngResExtDl", "standortEngRes2ExtDl"], ["#energieRes3ExtDl", "energieRes3ExtDl"], ["#messstelleEngRes3ExtDl", "messstelleEngRes3ExtDl"], ["#standort3EngResExtDl", "standortEngRes3ExtDl"], ["#energieRes4ExtDl", "energieRes4ExtDl"], ["#messstelleEngRes4ExtDl", "messstelleEngRes4ExtDl"], ["#standort4EngResExtDl", "standortEngRes4ExtDl"], ["#energieRes5ExtDl", "energieRes5ExtDl"], ["#messstelleEngRes5ExtDl", "messstelleEngRes5ExtDl"], ["#standort5EngResExtDl", "standortEngRes5ExtDl"], ["#energieRes6ExtDl", "energieRes6ExtDl"], ["#messstelleEngRes6ExtDl", "messstelleEngRes6ExtDl"], ["#standort6EngResExtDl", "standortEngRes6ExtDl"]].forEach(function(a) {
                    $(a[0]).val(c[b][a[1]])
    ...
    case "ber":
        $.ajax({
            ...
            success: function(a) {
                ...
                [["#berID", "ber_ID"], ["#nameAllgemeinBer", "nameBer"], ["#bereichAllgemeinAnl", "nameBer"], ["#kurzbezeichnungAllgemeinBer", "kurzbezeichnungBer"], ["#KostenstelleAllgemeinBer", "kostenstelleBer"], ["#ortBer", "ortBer"], ["#notizAllgemeinBer", "notizBer"], ["#levelAuswahlAllgemeinBer", "ausgewaehltesLevelBer"], ["#vorgelagerteBereiche1AllgemeinBer", "vorgelagerterBereich1Ber"], ["#vorgelagerteBereiche2AllgemeinBer", "vorgelagerterBereich2Ber"]].forEach(function(a) {
                    $(a[0]).val(c[b][a[1]])
                })) : clearFields("berHinz")
            }
        });
    ...
    case "mst":
        $.ajax({
            ...
            success: function(a) {
                ...
                0 < c.length ? ($("#aktivMst").prop("checked", c[b].aktivMst),
                $("#istDlMst").prop("checked", c[b].isDurchleitung),
                [["#mstID", "mst_ID"], ["#nameMst", "nameMSt"], ["#kurzbezeichnungMst", "kurzbezeichnungMst"], ["#kostenstelleMst", "kostenstelleMst"], ["#energietraegerMst", "energietraegerMst"], ["#energieformMst", "energieformMst"], ["#ortMst", "ortMst"], ["#messartMst", "messartMst"], ["#vorgelagerteMst", "vorgelagerteMessstelleMst"], ["#anlMst", "anl"], ["#anlIDMst", "anl_ID"], ["#messmittelBerechnungslogikMst", "msm"], ["#messmittelIDMst", "msm_ID"], ["#notizAllgemeinMst", "notizMst"]].forEach(function(a) {
                    $(a[0]).val(c[b][a[1]])
                })) : clearFields("mstHinz")
            }
        });
    ...
    case "std":
        $.ajax({
            ...
            success: function(a) {
                ...
                0 < a.length ? ($("#stdID").val(a[b].std_ID),
                $("#nameAllgemeinStd").val(a[b].nameStd),
                $("#kurzbezeichnungAllgemeinStd").val(a[b].kurzbezeichnungStd),
                $("#flaecheAllgemeinStd").val(a[b].flaecheStd),
                $("#custom1LabelStd").text(a[b].custom1LabelStd),
                $("#custom1EingabeStd").val(a[b].custom1InputStd),
                "" == $("#custom1LabelStd").text() ? $("#custom1Std").css("display", "none") : $("#custom1Std").css("display", "block"),
                $("#custom2LabelStd").text(a[b].custom2LabelStd),
                $("#custom2EingabeStd").val(a[b].custom2InputStd),
                "" == $("#custom2LabelStd").text() ? $("#custom2Std").css("display", "none") : $("#custom2Std").css("display", "block"),
                $("#custom3LabelStd").text(a[b].custom3LabelStd),
                $("#custom3EingabeStd").val(a[b].custom3InputStd),
                "" == $("#custom3LabelStd").text() ? $("#custom3Std").css("display", "none") : $("#custom3Std").css("display", "block"),
                $("#custom4LabelStd").text(a[b].custom4LabelStd),
                $("#custom4EingabeStd").val(a[b].custom4InputStd),
                "" == $("#custom4LabelStd").text() ? $("#custom4Std").css("display", "none") : $("#custom4Std").css("display", "block"),
                $("#custom5LabelStd").text(a[b].custom5LabelStd),
                $("#custom5EingabeStd").val(a[b].custom5InputStd),
                "" == $("#custom5LabelStd").text() ? $("#custom5Std").css("display", "none") : $("#custom5Std").css("display", "block"),
                $("#custom6LabelStd").text(a[b].custom6LabelStd),
                $("#custom6EingabeStd").val(a[b].custom6InputStd),
                "" == $("#custom6LabelStd").text() ? $("#custom6Std").css("display", "none") : $("#custom6Std").css("display", "block"),
                $("#notizAllgemeinStd").val(a[b].notizStd)) : clearFields("stdHinz")
            }
        });
        break;
    case "stdDr":
        $.ajax({
            ...
            success: function(a) {
                ...
                0 < c.length ? ([["#custom1LabelStdDr", "custom1LabelStdDr"], ["#custom2LabelStdDr", "custom2LabelStdDr"], ["#custom3LabelStdDr", "custom3LabelStdDr"], ["#custom4LabelStdDr", "custom4LabelStdDr"], ["#custom5LabelStdDr", "custom5LabelStdDr"], ["#custom6LabelStdDr", "custom6LabelStdDr"]].forEach(function(a) {
                    $(a[0]).text(c[b][a[1]])
                }),
                [["#stdDrID", "stdDr_ID"], ["#nameAllgemeinStdDr", "nameStdDr"], ["#kurzbezeichnungAllgemeinStdDr", "kurzbezeichnungStdDr"], ["#flaecheAllgemeinStdDr", "flaecheStdDr"], ["#custom5EingabeStdDr", "custom5InputStdDr"], ["#custom1EingabeStdDr", "custom1InputStdDr"], ["#custom6EingabeStdDr", "custom6InputStdDr"], ["#custom2EingabeStdDr", "custom2InputStdDr"], ["#notizAllgemeinStdDr", "notizStdDr"], ["#custom3EingabeStdDr", "custom3InputStdDr"], ["#custom4EingabeStdDr", "custom4InputStdDr"]].forEach(function(a) {
                    $(a[0]).val(c[b][a[1]])
    ...
    case "anl":
        $.ajax({
            ...
            success: function(a) {
                ...
                0 < c.length ? ($("#bildAllgemeinAnl").prop("src", c[b].bildAnl),
                ...
                [["#anlID", "anl_ID"], ["#idAllgemeinAnl", "anl_ID"], ["#bereichAllgemeinAnl", "nameBer"], ["#berID", "ber_ID"], ["#anlagennummerAllgemeinAnl", "nummerAnl"], ["#bezeichnungAllgemeinAnl", "bezeichnungAnl"], ["#typAllgemeinAnl", "typAnl"], ["#serienNrAllgemeinAnl", "serienNrAnl"], ["#standortAllgemeinAnl", "standortAnl"], ["#baujahrAnl", "baujahrAnl"], ["#datumAnschaffungAllgemeinAnl", "datumAnschaffungAnl"], ["#betriebsstundenAllgemeinAnl", "jahresbetriebsstundenAnl"], ["#notizAllgemeinAnl", "notizAnl"], ["#produktAllgemeinAnl", "produktAnl"], ["#produktionsmenge1AllgemeinAnl", "produktionsmengeAnl"], ["#einheitProduktionsmenge1AllgemeinAnl", "produktionsmengeEinheitAnl"], ["#produktnummer1AllgemeinAnl", "produktnummerAnl"], ["#zugeordneterVerbraucher1AllgemeinAnl", "zugeordneterVerbraucher1"], ["#zugeordneterVerbraucher2AllgemeinAnl", "zugeordneterVerbraucher2"], ["#zugeordneterVerbraucher3AllgemeinAnl", "zugeordneterVerbraucher3"], ["#zugeordneterVerbraucher4AllgemeinAnl", "zugeordneterVerbraucher4"], ["#zugeordneterVerbraucher5AllgemeinAnl", "zugeordneterVerbraucher5"], ["#zugeordneterVerbraucher6AllgemeinAnl", "zugeordneterVerbraucher6"], ["#zugeordneterVerbraucherID1AllgemeinAnl", "zugeordneterVerbraucherID1"], ["#zugeordneterVerbraucherID2AllgemeinAnl", "zugeordneterVerbraucherID2"], ["#zugeordneterVerbraucherID3AllgemeinAnl", "zugeordneterVerbraucherID3"], ["#zugeordneterVerbraucherID4AllgemeinAnl", "zugeordneterVerbraucherID4"], ["#zugeordneterVerbraucherID5AllgemeinAnl", "zugeordneterVerbraucherID5"], ["#zugeordneterVerbraucherID6AllgemeinAnl", "zugeordneterVerbraucherID6"], ["#energietraeger1AllgemeinAnl", "energietraeger1Anl"], ["#energieform1AllgemeinAnl", "energieform1Anl"], ["#einheit1Anl", "einheitEnergie1Anl"], ["#anschlussleistung1Anl", "anschlussleistung1Anl"], ["#mittlereAuslastungProzent1Anl", "mittlereAuslastungProzent1Anl"], ["#mittlereAuslastungKw1Anl", "mittlereAuslastungKw1Anl"], ["#betriebstemperatur1Anl", "betriebstemperatur1Anl"], ["#mst1Anl", "messstelle1Anl"], ["#mst1IDAnl", "messstelle1IDAnl"], ["#ber1Anl", "versBereich1Anl"], ["#abwaerme1Anl", "abwaerme1Anl"], ["#nutzbarkeitAbwaerme1Anl", "abwaermeNutzbarkeit1Anl"], ["#bewertungNutzbarkeitAbwaerme1Anl", "bewertungNutzbarkeitAbwaerme1Anl"], ["#energietraeger2AllgemeinAnl", "energietraeger2Anl"], ["#energieform2AllgemeinAnl", "energieform2Anl"], ["#einheit2Anl", "einheitEnergie2Anl"], ["#anschlussleistung2Anl", "anschlussleistung2Anl"], ["#mittlereAuslastungProzent2Anl", "mittlereAuslastungProzent2Anl"], ["#mittlereAuslastungKw2Anl", "mittlereAuslastungKw2Anl"], ["#betriebstemperatur2Anl", "betriebstemperatur2Anl"], ["#mst2Anl", "messstelle2Anl"], ["#mst2IDAnl", "messstelle2IDAnl"], ["#ber2Anl", "versBereich2Anl"], ["#abwaerme2Anl", "abwaerme2Anl"], ["#nutzbarkeitAbwaerme2Anl", "abwaermeNutzbarkeit2Anl"], ["#bewertungNutzbarkeitAbwaerme2Anl", "bewertungNutzbarkeitAbwaerme2Anl"], ["#energietraeger3AllgemeinAnl", "energietraeger3Anl"], ["#energieform3AllgemeinAnl", "energieform3Anl"], ["#einheit3Anl", "einheitEnergie3Anl"], ["#anschlussleistung3Anl", "anschlussleistung3Anl"], ["#mittlereAuslastungProzent3Anl", "mittlereAuslastungProzent3Anl"], ["#mittlereAuslastungKw3Anl", "mittlereAuslastungKw3Anl"], ["#betriebstemperatur3Anl", "betriebstemperatur3Anl"], ["#mst3Anl", "messstelle3Anl"], ["#mst3IDAnl", "messstelle3IDAnl"], ["#ber3Anl", "versBereich3Anl"], ["#abwaerme3Anl", "abwaerme3Anl"], ["#nutzbarkeitAbwaerme3Anl", "abwaermeNutzbarkeit3Anl"], ["#bewertungNutzbarkeitAbwaerme3Anl", "bewertungNutzbarkeitAbwaerme3Anl"], ["#energietraeger4AllgemeinAnl", "energietraeger4Anl"], ["#energieform4AllgemeinAnl", "energieform4Anl"], ["#einheit4Anl", "einheitEnergie4Anl"], ["#anschlussleistung4Anl", "anschlussleistung4Anl"], ["#mittlereAuslastungProzent4Anl", "mittlereAuslastungProzent4Anl"], ["#mittlereAuslastungKw4Anl", "mittlereAuslastungKw4Anl"], ["#betriebstemperatur4Anl", "betriebstemperatur4Anl"], ["#mst4Anl", "messstelle4Anl"], ["#mst4IDAnl", "messstelle4IDAnl"], ["#ber4Anl", "versBereich4Anl"], ["#abwaerme4Anl", "abwaerme4Anl"], ["#nutzbarkeitAbwaerme4Anl", "abwaermeNutzbarkeit4Anl"], ["#bewertungNutzbarkeitAbwaerme4Anl", "bewertungNutzbarkeitAbwaerme4Anl"], ["#custom1Anl", "custom1Anl"], ["#custom2Anl", "custom2Anl"], ["#custom3Anl", "custom3Anl"], ["#custom4Anl", "custom4Anl"], ["#custom5Anl", "custom5Anl"], ["#custom6Anl", "custom6Anl"]].forEach(function(a) {
                    $(a[0]).val(c[b][a[1]])
                })) : clearFields("anlHinz")
            }
        });
    ...
    case "msm":
        $.ajax({
            ...
            success: function(a) {
                console.log("records readInstanzen messmittel");
                console.log(a);
                var c = json(a);
                $("#msmCount").val(c.length);
                0 < c.length ? ($("#msmID").val(c[b].msm_ID),
                $("#bildAllgemeinMsm").prop("src", c[b].bildMsm),
                $("#multiboxAllgemeinMsm").prop("checked", c[b].multiboxMsm),
                $("#messtoleranzInformationenConfig").val(formatNumber("form", c[b].messtoleranzConfig)),
                $("#wandlungsfaktorTechnischeDetailsConfig").val(formatNumber("form", c[b].wandlungsfaktorMsm)),
                [["#messmittelNrAllgemeinMsm", "nrMsm"], ["#bezeichnungAllgemeinMsm", "bezeichnungMsm"], ["#messstelleAllgemeinMsm", "mst"], ["#messstelleIDAllgemeinMsm", "mst_ID"], ["#anlMsm", "anl"], ["#anlIDMsm", "anl_ID"], ["#typAllgemeinMsm", "typMsm"], ["#typNrAllgemeinMsm", "typNrMsm"], ["#installationsdatumAllgemeinMsm", "installationsdatumMsm"], ["#entMsm", "energietraegerMsm"], ["#einheitAllgemeinMsm", "einheitMsm"], ["#unitAllgemeinMsm", "unitMsm"], ["#unitTypAllgemeinMsm", "unitTypMsm"], ["#anzahlKanaeleAllgemeinMsm", "anzahlKanaeleMsm"], ["#messungsformAllgemeinMsm", "messungsformMsm"], ["#kanal1AllgemeinMsm", "kanal1Msm"], ["#kanal2AllgemeinMsm", "kanal2Msm"], ["#kanal3AllgemeinMsm", "kanal3Msm"], ["#notizAllgemeinMsm", "notizAllgemeinMsm"], ["#beauftragterPruefinformationenMsm", "nameBeauftragterMsm"], ["#beauftragterEmailPruefinformationenMsm", "emailBeauftragterMsm"], ["#pruefzyklusPruefinformationenMsm", "pruefzyklusMsm"], ["#letztePruefungPruefinformationenMsm", "letztePruefungMsm"], ["#naechstePruefungPruefinformationenMsm", "naechstePruefungMsm"], ["#notiz2AllgemeinMsm", "notizPruefungsinformationenMsm"], ["#messmethodeInformationenConfig", "messmethodeConfig"], ["#messzyklusInformationenConfig", "messzyklusConfig"], ["#notiz1InformationenConfig", "notizAllgemeinConfig"], ["#verbrauchswertbildungConfig", "verbrauchswertbildungConfig"], ["#geraetetypTechnischeDetailsConfig", "geraeteTypMsm"], ["#ipTechnischeDetailsConfig", "ipAdresseConfig"], ["#subnetMaskTechnischeDetailsConfig", "subnetMaskConfig"], ["#gatewayTechnischeDetailsConfig", "gatewayConfig"], ["#cgiPortTechnischeDetailsConfig", "cgiPortConfig"], ["#modbusPortTechnischeDetailsConfig", "modbusPortConfig"], ["#ftpPortTechnischeDetailsConfig", "ftpPortConfig"], ["#notiz2InformationenConfig", "notizTechnischeDetailsConfig"]].forEach(function(a) {
                    $(a[0]).val(c[b][a[1]])
                })) : clearFields("msmHinz")
            }
        });
        ...
        $.ajax({
            ...
            success: function(a) {
                ...
                if (0 < c.length) {
                    ...
                    [["#bezeichnungPrd", "namePrd"], ["#artklnrPrd", "artikelNrPrd"], ["#custom1Prd", "custom1"], ["#custom2Prd", "custom2"], ["#custom3Prd", "custom3"], ["#custom4Prd", "custom4"], ["#custom5Prd", "custom5"], ["#custom6Prd", "custom6"], ["#inpAnlage1Prd", "anl01"], ["#inpAnlage1IDPrd", "anl01ID"], ["#inpAnlage2Prd", "anl02"], ["#inpAnlage2IDPrd", "anl02ID"], ["#inpAnlage3Prd", "anl03"], ["#inpAnlage3IDPrd", "anl03ID"], ["#inpAnlage4Prd", "anl04"], ["#inpAnlage4IDPrd", "anl04ID"], ["#inpAnlage5Prd", "anl05"], ["#inpAnlage5IDPrd", "anl05ID"], ["#inpAnlage6Prd", "anl06"], ["#inpAnlage6IDPrd", "anl06ID"], ["#inpAnlage7Prd", "anl07"], ["#inpAnlage7IDPrd", "anl07ID"], ["#inpAnlage8Prd", "anl08"], ["#inpAnlage8IDPrd", "anl08ID"], ["#inpAnlage9Prd", "anl09"], ["#inpAnlage9IDPrd", "anl09ID"], ["#gruppenIDPrd", "gruppenID"]].forEach(function(a) {
                        $(a[0]).val(c[b][a[1]])
                    });
    ...
    case "ent":
        $.ajax({
            ...
            success: function(a) {
                ...
                0 < c.length ? ([["#entID", "ent_ID"], ["#nameEnt", "nameEnt"], ["#kuerzelEnt", "kuerzelEnt"], ["#notizEnt", "notizEnt"], ["#allgemEntEnt", "allgemeinerEnt"]].forEach(function(a) {
                    $(a[0]).val(c[b][a[1]])
                }),
                $.ajax({
                    type: "POST",
                    ...
                    success: function(a) {
                        ...
                        a = b.length;
                        if (0 < a) {
                            [["#lblEntEinh1FaktorX1", "lblEntEinh1FaktorX1"], ["#lblEntEinh2FaktorX1", "lblEntEinh2FaktorX1"], ["#lblEntEinh3FaktorX1", "lblEntEinh3FaktorX1"], ["#lblEntEinh1FaktorX2", "lblEntEinh1FaktorX2"], ["#lblEntEinh2FaktorX2", "lblEntEinh2FaktorX2"], ["#lblEntEinh3FaktorX2", "lblEntEinh3FaktorX2"], ["#lblEntEinh1FaktorX3", "lblEntEinh1FaktorX3"], ["#lblEntEinh2FaktorX3", "lblEntEinh2FaktorX3"], ["#lblEntEinh3FaktorX3", "lblEntEinh3FaktorX3"]].forEach(function(a) {
                                $(a[0]).text(b[0][a[1]])
                            });
                            [["#versID", "vers_ID"], ["#versorgerEvuEnt", "versorgerEvu"], ["#versorgerUenbEnt", "versorgerUenb"], ["#versorgerMsbEnt", "versorgerMsb"], ["#einheit1Ent", "einheit1Ent"], ["#einheit2Ent", "einheit2Ent"], ["#einheit3Ent", "einheit3Ent"], ["#entEinh1FaktorKwh", "entEinh1FaktorKwh"], ["#entEinh2FaktorKwh", "entEinh2FaktorKwh"], ["#entEinh3FaktorKwh", "entEinh3FaktorKwh"], ["#entEinh1FaktorCO2", "entEinh1FaktorCO2"], ["#entEinh2FaktorCO2", "entEinh2FaktorCO2"], ["#entEinh3FaktorCO2", "entEinh3FaktorCO2"], ["#entEinh1FaktorX1", "entEinh1FaktorX1"], ["#entEinh2FaktorX1", "entEinh2FaktorX1"], ["#entEinh3FaktorX1", "entEinh3FaktorX1"], ["#entEinh1FaktorX2", "entEinh1FaktorX2"], ["#entEinh2FaktorX2", "entEinh2FaktorX2"], ["#entEinh3FaktorX2", "entEinh3FaktorX2"], ["#entEinh1FaktorX3", "entEinh1FaktorX3"], ["#entEinh2FaktorX3", "entEinh2FaktorX3"], ["#entEinh3FaktorX3", "entEinh3FaktorX3"], ["#gueltigVomEnt", "gueltigVomEnt"], ["#gueltigBisEnt", "gueltigBisEnt"]].forEach(function(a) {
                                $(a[0]).val(b[0][a[1]])
                            });
                            var c = tblVersorgerHistorie;
                            c.clear();
                            for (var e = 0; e < a - 1; e++)
                                c.row.add([c.rows().count(), b[e].versorgerEvu, b[e].versorgerUenb, b[e].versorgerMsb, b[e].gueltigVomEnt + " - " + b[e].gueltigBisEnt]);
                            c.draw()
                        }
                    }
                })) : clearFields("entHinz")
    ...
    case "enf":
        $.ajax({
            ...
            success: function(a) {
                ...
                0 < a.length ? ($("#enfID").val(a[b].enf_ID),
                $("#nameEnf").val(a[b].nameEnf),
                $("#kuerzelEnf").val(a[b].kuerzelEnf),
                $("#notizEnf").val(a[b].notizEnf),
                $("#aktivEnf").prop("checked", a[b].aktivEnf),
                $("#einheit1Enf").val(a[b].einheit1Enf),
                $("#einheit2Enf").val(a[b].einheit2Enf),
                $("#einheit3Enf").val(a[b].einheit3Enf),
                $("#enfEinh1FaktorKwh").val(a[b].enfEinh1FaktorKwh),
                $("#enfEinh2FaktorKwh").val(a[b].enfEinh2FaktorKwh),
                $("#enfEinh3FaktorKwh").val(a[b].enfEinh3FaktorKwh),
                $("#enfEinh1FaktorCO2").val(a[b].enfEinh1FaktorCO2),
                $("#enfEinh2FaktorCO2").val(a[b].enfEinh2FaktorCO2),
                $("#enfEinh3FaktorCO2").val(a[b].enfEinh3FaktorCO2),
                $("#lblEnfEinh1FaktorX1").text(a[b].lblEnfEinh1FaktorX1),
                $("#lblEnfEinh2FaktorX1").text(a[b].lblEnfEinh2FaktorX1),
                $("#lblEnfEinh3FaktorX1").text(a[b].lblEnfEinh3FaktorX1),
                $("#enfEinh1FaktorX1").val(a[b].enfEinh1FaktorX1),
                $("#enfEinh2FaktorX1").val(a[b].enfEinh2FaktorX1),
                $("#enfEinh3FaktorX1").val(a[b].enfEinh3FaktorX1),
                $("#lblEnfEinh1FaktorX2").text(a[b].lblEnfEinh1FaktorX2),
                $("#lblEnfEinh2FaktorX2").text(a[b].lblEnfEinh2FaktorX2),
                $("#lblEnfEinh3FaktorX2").text(a[b].lblEnfEinh3FaktorX2),
                $("#enfEinh1FaktorX2").val(a[b].enfEinh1FaktorX2),
                $("#enfEinh2FaktorX2").val(a[b].enfEinh2FaktorX2),
                $("#enfEinh3FaktorX2").val(a[b].enfEinh3FaktorX2),
                $("#lblEnfEinh1FaktorX3").text(a[b].lblEnfEinh1FaktorX3),
                $("#lblEnfEinh2FaktorX3").text(a[b].lblEnfEinh2FaktorX3),
                $("#lblEnfEinh3FaktorX3").text(a[b].lblEnfEinh3FaktorX3),
                $("#enfEinh1FaktorX3").val(a[b].enfEinh1FaktorX3),
                $("#enfEinh2FaktorX3").val(a[b].enfEinh2FaktorX3),
                $("#enfEinh3FaktorX3").val(a[b].enfEinh3FaktorX3),
                $("#gueltigVomEnf").val(a[b].gueltigVomEnf),
                $("#gueltigBisEnf").val(a[b].gueltigBisEnf)) : clearFields("enfHinz")
            }
        });
        break;
    case "eRng":
        $.ajax({
            ...
            success: function(a) {
                a = json(a);
                0 < a.length ? ($("#eRngID").val(a[b].eRng_ID),
                $("#eRngCount").val(a.length),
                $("#eRngID").val(a[b].eRng_ID),
                $("#entERng").val(a[b].entERng),
                $("#modusERng").val(a[b].rechnungsmodusERng),
                $("#nrERng").val(a[b].nrERng),
                $("#zpNrERng").val(a[b].zpNrERng),
                $("#mstERng").val(a[b].mst),
                $("#mstIDERng").val(a[b].mst_ID),
                $("#datumERng").val(a[b].datumERng),
                $("#vomERng").val(a[b].vomERng),
                $("#bisERng").val(a[b].bisERng),
                $("#einERng").val(a[b].einERng),
                $("#mengeERng").val(formatNumber("form", a[b].mengeERng)),
                $("#verbrauchERng").val(formatNumber("form", a[b].verbrauchERng)),
                $("#kostenERng").val(a[b].kostenERng),
                $("#kostenstelleERng").val(a[b].kostenstelleERng),
                $("#versorgerERng").val(a[b].versorgerERng),
                0 == a[b].tagstromVerbrERng && 0 == a[b].tagstromKostERng && 0 == a[b].nachtstromVerbrERng && 0 == a[b].nachtstromKostERng ? ($("#htNt").css("display", "none"),
                $(".htNtInp").val(""),
                $(this).text("HT/NT aktivieren")) : ($("#htNt").css("display", "block"),
                $(this).text("HT/NT deaktivieren")),
                versorgerUndEinheitBefuellen(),
                $("#tagstromVerbrERng").val(formatNumber("form", a[b].tagstromVerbrERng)),
                $("#tagstromKostERng").val(formatNumber("form", a[b].tagstromKostERng)),
                $("#nachtstromVerbrERng").val(formatNumber("form", a[b].nachtstromVerbrERng)),
                $("#nachtstromKostERng").val(formatNumber("form", a[b].nachtstromKostERng)),
                $("#blindstromERng").val(formatNumber("form", a[b].blindstromERng)),
                $("#lastspitzeERng").val(formatNumber("form", a[b].lastspitzeERng)),
                $("#leistungspreisERng").val(formatNumber("form", a[b].leistungspreisERng)),
                $("#abpWirkERng").val(formatNumber("form", a[b].abpWirkERng)),
                $("#strSteuERng").val(formatNumber("form", a[b].strSteuERng)),
                $("#eegERng").val(formatNumber("form", a[b].eegERng)),
                $("#eegUntERng").val(formatNumber("form", a[b].eegUntERng)),
                $("#eegUebERng").val(formatNumber("form", a[b].eegUebERng)),
                $("#abpNetzERng").val(formatNumber("form", a[b].abpNetzERng)),
                $("#konzERng").val(formatNumber("form", a[b].konzERng)),
                $("#kwkUntERng").val(formatNumber("form", a[b].kwkUntERng)),
                $("#kwkObERng").val(formatNumber("form", a[b].kwkObERng)),
                $("#nevUntERng").val(formatNumber("form", a[b].nevUntERng)),
                $("#nevObERng").val(formatNumber("form", a[b].nevObERng)),
                $("#offUntERng").val(formatNumber("form", a[b].offUntERng)),
                $("#offObERng").val(formatNumber("form", a[b].offObERng)),
                $("#lblCustom1ERng").text(a[b].lblCustom1ERng),
                $("#custom1ERng").val(formatNumber("form", a[b].Custom1ERng)),
                $("#lblCustom2ERng").text(a[b].lblCustom2ERng),
                $("#custom2ERng").val(formatNumber("form", a[b].Custom2ERng)),
                $("#lblCustom3ERng").text(a[b].lblCustom3ERng),
                $("#custom3ERng").val(formatNumber("form", a[b].Custom3ERng)),
                $("#lblCustom4ERng").text(a[b].lblCustom4ERng),
                $("#custom4ERng").val(formatNumber("form", a[b].Custom4ERng)),
                $("#lblCustom5ERng").text(a[b].lblCustom5ERng),
                $("#custom5ERng").val(formatNumber("form", a[b].Custom5ERng)),
                $("#lblCustom6ERng").text(a[b].lblCustom6ERng),
                $("#custom6ERng").val(formatNumber("form", a[b].Custom6ERng))) : clearFields("eRngHinz");
    ...
    case "intEngIMw":
        $.ajax({
            ...
            success: function(a) {
                ...
                0 < a.length ? ($("#mstID").val(a[b].mst_ID),
                $("#mstIMw").val(a[b].nameMSt),
                $("#energietraegerIMw").val(a[b].energietraegerMst),
                $("#zeitintervallMst").val(a[b].zeitintervallMst),
                $("#einheitMst").val(a[b].einheitMst),
                $("#notizMesswertManuell").val(a[b].notizMesswertManuell)) : clearFields("iMwHinz")
            }
        });
        break;
    case "intBdeIMw":
        $.ajax({
            ...
            success: function(a) {
                ...
                [["#anlIMw", "bezeichnungAnl"], ["#anlNrIMw", "nummerAnl"], ["#zeitintervallAnl", "zeitintervallAnl"], ["#einheitAnl", "einheitAnl"], ["#notizBdeIMw", "notizMesswertManuell"]].forEach(function(a) {
                    $(a[0]).val(c[b][a[1]])
                })) : clearFields("iMwHinz")
            }
        });
    ...
    case "eAnl":
        $.ajax({
            ...
            success: function(a) {
                ...
                0 < c.length ? ([["#eAnlID", "eAnl_ID"], ["#nameEAnl", "name"], ["#kuerzelEAnl", "kurz"], ["#beschreibungEAnl", "beschreibung"]].forEach(function(a) {
                    $(a[0]).val(c[b][a[1]])
                }),
                tblOptionenEAnl.clear().draw(),
                c[b].optionen.split(",").forEach(function(a) {
    ...
    case "ePrd":
        $.ajax({
            ...
            success: function(a) {
                ...
                0 < c.length ? ([["#ePrdID", "ePrd_ID"], ["#nameEPrd", "name"], ["#kuerzelEPrd", "kurz"], ["#beschreibungEPrd", "beschreibung"]].forEach(function(a) {
                    $(a[0]).val(c[b][a[1]])
                }),
                tblOptionenEPrd.clear().draw(),
                c[b].optionen.split(",").forEach(function(a) {
    ...
    case "zp":
        $.ajax({
            ...
            success: function(a) {
                ...
                0 < c.length ? [["#zpID", "zp_ID"], ["#zaehlpunktNrZp", "zaehlpunktNr"], ["#energietraegerZp", "energietraegerZp"], ["#mstZp", "mstZp"], ["#messsystemZp", "messsystemZp"], ["#messgenauZp", "messgenauigkeitZp"]].forEach(function(a) {
                    $(a[0]).val(c[b][a[1]])
                }) : clearFields("zpHinz")
            }
        });
        ...
        $.ajax({
            ...
            success: function(a) {
                ...
                if (0 < c.length) {
                    ...
                    [["#knzInsID", "knzIns_ID"], ["#bezugAllgemeinKnz", "bezug"], ["#instanzAllgemeinKnz", "instanz"], ["#instanzAllgemeinIDKnz", "id"], ["#zustaendigerMitarbeiterAllgemeinKnz", "zustaendigerMitarbeiter"], ["#beschreibungAllgemeinKnz", "beschreibung"]].forEach(function(a) {
                        $(a[0]).val(c[b][a[1]])
                    });
                    var e = c[b].nKnzs;
                    $.ajax({
                        ...
                        success: function(a) {
                            ...
                            if (0 < b.length) {
                                ...
                                for (var c = 1; c < a; c++)
                                    $("#btnTabKnzCont li").eq(c).css("display", "none");
                                ...
                                a.i$9++)
                                    $("#btnTabKnzCont li").eq(a.i$9).css("display", "inline"),
                                    $("#status" + (a.i$9 + 1) + "Knz").prop("checked", b[a.i$9].aktiv),
                                    $("#formel" + (a.i$9 + 1) + "Knz").val(atob(b[a.i$9].formelString)),
                                    $(".knzForms").eq(a.i$9).text(b[a.i$9].bezeichnung),
                                    [["#bez_" + (a.i$9 + 1) + "_Knz", "bezeichnung"], ["#anwendungsbereichKennzahldetails" + (a.i$9 + 1) + "Knz", "anwendungsbereich"], ["#datumEinfuehrung" + (a.i$9 + 1) + "Knz", "datumEinfuehrung"], ["#datumLetzteUeberpruefung" + (a.i$9 + 1) + "Knz", "letzteUeberpruefung"], ["#datumDeaktivierung" + (a.i$9 + 1) + "Knz", "datumDeaktivierung"], ["#einheitKennzahldetail" + (a.i$9 + 1) + "Knz", "einheit"], ["#formel" + (a.i$9 + 1) + "IDKnz", "frm_ID"], ["#kennzahl" + (a.i$9 + 1) + "Knz", "kennzahl"], ["#toleranzgrenzeOben" + (a.i$9 + 1) + "Knz", "grenzwertO"], ["#toleranzgrenzeUnten" + (a.i$9 + 1) + "Knz", "grenzwertU"], ["#zielwert" + (a.i$9 + 1) + "Knz", "zielwert"], ["#zielVon" + (a.i$9 + 1) + "Knz", "zielVon"], ["#zielBis" + (a.i$9 + 1) + "Knz", "zielBis"]].forEach(function(a) {
                                        return function(c) {
                                            $(c[0]).val(b[a.i$9][c[1]])
                                        }
                                    }(a));
...
function readInstanzNachID(a, b) {
    var e = new DataMachine, c = [], g, f, h = "";
    switch (a) {
    ...
    e.runQuery("read", $("#nameDB").val(), h).then(function(a) {
        a = json(a);
        for (var b = c, e = b.length, g = 0; g < e; g++)
            $("#" + b[g].htmlID).val(a[0][b[g].dbColumnName])
    })
}
function clearFields(a) {
    ...
    $("#abwaerme4Anl").val(0)) : "prdHinz" == a ? b = "#bezeichnungPrd #artklnrPrd #custom1Prd #custom2Prd #custom3Prd #custom4Prd #custom5Prd #custom6Prd #inpAnlage1Prd #inpAnlage2Prd #inpAnlage3Prd #inpAnlage4Prd #inpAnlage5Prd #inpAnlage6Prd #inpAnlage8Prd #inpAnlage9Prd".split(" ") : "entHinz" == a ? (b = "#nameEnt #kuerzelEnt #allgemEntEnt #notizEnt #versorgerEvuEnt #versorgerUenbEnt #versorgerMsbEnt #einheit1Ent #einheit2Ent #einheit3Ent #entEinh1FaktorKwh #entEinh2FaktorKwh #entEinh3FaktorKwh #entEinh1FaktorCO2 #entEinh2FaktorCO2 #entEinh3FaktorCO2 #entEinh1FaktorX1 #entEinh2FaktorX1 #entEinh3FaktorX1 #entEinh1FaktorX2 #entEinh2FaktorX2 #entEinh3FaktorX2 #entEinh1FaktorX3 #entEinh2FaktorX3 #entEinh3FaktorX3 #gueltigVomEnt #gueltigBisEnt".split(" "),
    ...
    $("#status1Knz").prop("checked", !1),
    $("#status2Knz").prop("checked", !1),
    $("#status3Knz").prop("checked", !1),
    $("#status4Knz").prop("checked", !1),
    $("#status5Knz").prop("checked", !1),
    $("#status6Knz").prop("checked", !1),
    $("#status7Knz").prop("checked", !1),
    $("#status8Knz").prop("checked", !1),
    $("#status9Knz").prop("checked", !1),
    $("#status10Knz").prop("checked", !1));
    b.forEach(function(a) {
        $(a).val("")
    });
    savedNew = !0
}
function fensterLoeschenmeldung(a) {
...
var entOderEnf;
function checkboxenDerEntEnfEinlesen(a) {
    ...
    $.ajax({
        ...
        success: function(b) {
            ...
            for (i = 0; i < b.length; i++)
                "ent" == $(a).prop("value") ? (e = 1 == b[i].aktivEnt ? "checked" : "",
                $("#frmEntEnfManZuordnung").append("<div class='controlDiv' style='width:230px;margin-right:4px;'><label style='width:160px;'> " + b[i].nameEnt + "</br>(" + b[i].gueltigkeitEnt + ") </label > <input type='checkbox' style='width:45px;' " + e + " /></div >")) : (e = 1 == b[i].aktivEnf ? "checked" : "",
...
function entEnfStatusSpeichern() {
    ...
    for (i = 0; i < $("#frmEntEnfManZuordnung input").length; i++)
        a[i] = $("#frmEntEnfManZuordnung input").eq(i).is(":checked");
    $.ajax({
        type: "POST",
        async: !0,
...
function liegenschaftenlisteErstellen() {
    $.ajax({
        ...
        success: function(a) {
            ...
            for (var b = 0; b < a.length; b++)
                tblLiegenschaftenSuchen.row.add([b, a[b].nameLieg, a[b].typLieg, a[b].anschriftLieg, a[b].ortLieg, a[b].nameAnsprechpartnerLieg, a[b].nameEnergiebeauftragterLieg]).draw();
...
function extDurchleitungenlisteErstellen() {
    $.ajax({
        ...
        success: function(a) {
            ...
            for (var b = 0; b < a.length; b++)
                tblExtDurchleitungenSuchen.row.add([b, a[b].nameExtDl, a[b].typExtDl, a[b].anschriftExtDl, a[b].ortExtDl, a[b].nameAnsprechpartnerExtDl]).draw();
...
function standortelisteErstellen() {
    $.ajax({
        ...
        success: function(a) {
            ...
            for (var b = 0; b < a.length; b++)
                tblStandorteSuchen.row.add([b, a[b].nameStd, a[b].kurzbezeichnungStd, a[b].flaecheStd]).draw();
...
function standorteDritterlisteErstellen() {
    $.ajax({
        ...
        success: function(a) {
            ...
            for (var b = 0; b < a.length; b++)
                tblStandorteDritterSuchen.row.add([b, a[b].nameStdDr, a[b].kurzbezeichnungStdDr, a[b].flaecheStdDr]).draw();
...
function bereichelisteErstellen() {
    $.ajax({
        ...
        success: function(a) {
            ...
            for (var b = 0; b < a.length; b++)
                tblBereicheSuchen.row.add([b, a[b].nameBer, a[b].kurzbezeichnungBer, a[b].kostenstelleBer, a[b].ortBer, a[b].ausgewaehltesLevelBer, a[b].vorgelagerterBereich1Ber, a[b].vorgelagerterBereich2Ber]).draw();
...
function anlagenlisteErstellen() {
    ...
    $.ajax({
        ...
        success: function(a) {
            ...
            for (var b = 0; b < a.length; b++)
                tblAnlagen.row.add([b, a[b].lieg_ID, a[b].nameLieg, a[b].nummerAnl, a[b].bezeichnungAnl, a[b].typAnl, a[b].standortAnl, a[b].datumAnschaffungAnl, a[b].baujahrAnl, a[b].jahresbetriebsstundenAnl, a[b].produktAnl, a[b].produktnummerAnl, a[b].energietraeger1Anl, a[b].energieform1Anl, a[b].einheitEnergie1Anl, a[b].anschlussleistung1Anl, a[b].mittlereAuslastungKw1Anl]).draw();
...
function messmittellisteErstellen() {
    $.ajax({
        ...
        success: function(a) {
            ...
            for (var b = 0; b < a.length; b++)
                tblMessmittelSuchen.row.add([b, a[b].nrMsm, a[b].bezeichnungMsm, a[b].anlageMsm, a[b].messstelleMsm, a[b].energietraegerMsm, a[b].einheitMsm, a[b].pruefzyklusMsm, a[b].naechstePruefungMsm]).draw();
...
function formellisteErstellen(a) {
    var b = void 0
      , e = void 0;
    "kennzahl" === a ? (b = "php/getFormeln.php",
    e = {
        id: "frm_ID",
        name: "nameFormel",
        formelString: "formelString",
        formelIdString: "idString"
    }) : (b = "php/berechnungsformeln.php",
    e = {
        id: "mst_ID",
        name: "nameMSt",
    ...
    $.ajax({
        ...
        success: function(a) {
            ...
            for (var b = 0; b < a.length; b++)
                tblformelSuchen.row.add([a[b][e.id], a[b][e.name], atob(a[b][e.formelString]), atob(a[b][e.formelIdString])]).draw();
...
function messstellenlisteErstellen() {
    $.ajax({
        ...
        success: function(a) {
            ...
            for (var b = 0; b < a.length; b++)
                tblMessstellenSuchen.row.add([b, a[b].nameMSt, a[b].kurzbezeichnungMst, a[b].kostenstelleMst, a[b].energietraegerMst, a[b].messmittelBerechnungslogikMst, a[b].anlageMst, a[b].ortMst]).draw();
...
function externeRechnungenListeErstellen(a) {
    $.ajax({
        type: "POST",
        async: !0,
        ...
        success: function(b) {
            ...
            if ("lupe" == a) {
                ...
                for (b = 0; b < e.length; b++)
                    ...
                    tblExterneRechnungenSuchen.row.add([b, e[b].mst, e[b].nrERng, e[b].kostenstelleERng, e[b].vomERng, e[b].bisERng, e[b].entERng, e[b].einERng, e[b].versorgerERng, c, g]).draw();
                ...
                var f = [], h, q;
                for (b = 0; b < e.length; b++) {
                    if (10 == e[b].bisERng.length)
                        switch (c = e[b].bisERng,
                        f = c.split("."),
                        f[1]) {
                        case "01":
                            h = "1.Quartal";
...
function energietraegerlisteErstellen() {
    $.ajax({
        ...
        success: function(a) {
            ...
            for (var b = 0; b < a.length; b++)
                tblEnergietraegerSuchen.row.add([b, a[b].nameEnt, a[b].allgemeinerEnt]).draw();
...
function energieformenlisteErstellen() {
    $.ajax({
        ...
        success: function(a) {
            ...
            for (var b = 0; b < a.length; b++)
                tblEnergieformenSuchen.row.add([b, a[b].nameEnf, a[b].aktivEnf]).draw();
...
function produktelisteErstellen() {
    $.ajax({
        type: "POST",
        async: !0,
        ...
        success: function(a) {
            ...
            for (var b = 0; b < a.length; b++)
                tblProdukteSuchen.row.add([b, a[b].artikelNrPrd, a[b].namePrd, a[b].custom1, a[b].custom2, a[b].custom3]).draw();
...
function vorlagenformellisteErstellen() {
    $.ajax({
        type: "POST",
        async: !0,
        ...
        success: function(a) {
            ...
            for (var b = 0; b < a.length; b++)
                tblVorlagenformelnSuchen.row.add([b, a[b].bezeichnung, atob(a[b].formel), a[b].notiz]).draw();
...
function kennzahlInstanzenlisteErstellen() {
    $.ajax({
        type: "POST",
        async: !0,
        url: "php/readKennzahlen.php",
        ...
        success: function(a) {
            ...
            for (var b = 0; b < a.length; b++) {
                ...
                tblKennzahlInstanzSuchen.row.add([b, e, a[b].instanz, a[b].beschreibung]).draw()
            }
            ...
            $("#kennzahlInstanzSuchenContainer").dialog({
                ...
                open: function() {
                    ...
                    $("#tblKennzahlInstanzSuchen tbody").on("dblclick", "tr", function() {
...
function spezielleKennzahlenlisteErstellen() {
    $.ajax({
        type: "POST",
        async: !0,
        url: "php/readKennzahlen.php",
        ...
        success: function(a) {
            ...
            for (var b = 0; b < a.length; b++)
                tblSpezKennzahlSuchen.row.add([b, a[b].knzIns_ID, a[b].bezeichnung, a[b].aktiv, a[b].anwendungsbereich, a[b].einheit, a[b].kennzahl, atob(a[b].formelString)]).draw();
...
function instanzAuswahllisteErstellen(a) {
    $.ajax({
        type: "POST",
        async: !0,
        ...
        success: function(b) {
            ...
            case "mst":
                ...
                for (var f = 0; f < e.length; f++)
                    tblInstanzMstSuchen.row.add([e[f].mst_ID, e[f].nameMSt, e[f].energietraegerMst, e[f].messmittelBerechnungslogikMst, e[f].anlageMst, e[f].ortMst]).draw();
            ...
            case "anl":
                ...
                for (f = 0; f < e.length; f++)
                    tblInstanzAnlSuchen.row.add([e[f].anl_ID, e[f].nummerAnl + " " + e[f].bezeichnungAnl, e[f].messstelle1Anl, e[f].energietraeger1Anl]).draw();
                g = tblInstanzAnlSuchen;
                break;
            case "prd":
                $("#div_tblInstanzAnl, #div_tblInstanzMst").css("display", "none");
                $("#div_tblInstanzPrd").css("display", "block");
                c = "#tblInstanzPrdSuchen";
                tblInstanzPrdSuchen.clear().draw();
                for (f = 0; f < e.length; f++)
                    tblInstanzPrdSuchen.row.add([e[f].prd_ID, e[f].namePrd, e[f].artikelNrPrd]).draw();
            ...
            $("#instanzSuchenContainer").dialog({
                ...
                open: function() {
                    ...
                    $(c + " tbody").off("dblclick", "tr");
                    $(c + " tbody").on("dblclick", "tr", function() {
                        var a = g.row(this).data();
                        if ("#tblInstanzPrdSuchen" === c)
                            for (f = 0; f < e.length; f++)
                                e[f].prd_ID === a[0] && ($("#custom1PrdKnz").val(e[f].custom1),
                                $("#custom2PrdKnz").val(e[f].custom2),
                                $("#custom3PrdKnz").val(e[f].custom3),
                                $("#custom4PrdKnz").val(e[f].custom4),
                                $("#custom5PrdKnz").val(e[f].custom5),
                                $("#custom6PrdKnz").val(e[f].custom6));
                        $("#instanzAllgemeinIDKnz").val(a[0]);
                        $("#instanzAllgemeinKnz").val(a[1] + "_" + a[2]);
                        $("#bezKnz").val($("#bezugAllgemeinKnz").val() + "-" + a[1]);
...
function formelAuswahllisteErstellen(a, b) {
    $.ajax({
        type: "POST",
        async: !0,
        ...
        success: function(e) {
            ...
            for (var c = 0; c < e.length; c++)
                tblFormeln.row.add([e[c].frm_ID, atob(e[c].formelString)]).draw();
...
function tabellenAuswahllisteErstellen(a) {
    $.ajax({
        type: "POST",
        async: !0,
        ...
        success: function(b) {
            ...
            for (var e = 0; e < b.length; e++)
                tblTabellenProdSuchen.row.add([b[e].object_id, b[e].name, b[e].schema_id]).draw();
...
function produkteAuswahllisteErstellen(a, b) {
    $.ajax({
        type: "POST",
        async: !0,
        url: "php/getProdukte.php",
        ...
        success: function(e) {
            ...
            for (var c = 0; c < e.length; c++)
                tblProdukteFenster.row.add([e[c].prd_ID, e[c].artikelNrPrd, e[c].namePrd, e[c].custom1]).draw();
...
function vorlagenformelAuswahllisteErstellen() {
    $.ajax({
        type: "POST",
        async: !0,
                ...
                open: function() {
                    ...
                    $("#tblVorlFrmZuordnen tbody").on("dblclick", "tr", function() {
                        ...
                        filterInstanzen(a[2]).forEach(function(a, b) {
                            $("#vorlFrmFuellen").append('\n                                <div style="font-size: 14px;">\n                                <label id="lblAuswahlVorlFrmIns' + b + '" style="display: inline-block;width: 200px;"><img id="auswahlVorlFrmIns' + b + '" title="Instanz ausw\u00e4hlen" src="images/search.png" alt="suchen, ausw\u00e4hlen" style="height:10px;width:10px;float:right;" />' + a + '</label>\n                                <input id="inpAuswahlVorlFrmIns' + b + '" class="vorlString" tyle="width:150px; font-size: 12px;" readonly/>\n                                <input id="inpAuswahlVorlFrmIDIns' + b + '" class="vorlID" style="display:none;"/>\n                                </div>\n                                ');
...
function mandantenAuswahllisteErstellen() {
    $.ajax({
        ...
        success: function(a) {
            ...
            for (var b = 0; b < a.length; b++)
                tblMandantenAuswahl.row.add([a[b].man_ID, a[b].nameMan, a[b].dbName, a[b].holdingstruktur]).draw();
...
function gespeicherteDiagrammeAuswahllisteErstellen() {
    sessionStorage.setItem("nameDB", $("#nameDB").val());
    ...
    $.ajax({
        ...
        success: function(a) {
            ...
            console.log("type json(records) of: " + typeof json(a));
            ...
            $("#diagrammeAuswahlContainer").dialog({
                ...
                open: function() {
                    ...
                    $("#tblGespDiagrammeListe tbody").off("dblclick", "tr");
...
function standortdatenDritteAuswahllisteErstellen(a) {
    $.ajax({
        type: "POST",
        async: !0,
        url: "php/getStandortdatenDritter.php",
        ...
        success: function(b) {
            ...
            for (var e = 0; e < b.length; e++)
                tblStdDrAuswahl.row.add([b[e].nameStdDr, b[e].kurzbezeichnungStdDr, b[e].flaecheStdDr, b[e].custom1InputStdDr, b[e].custom2InputStdDr, b[e].custom3InputStdDr, b[e].custom4InputStdDr, b[e].custom5InputStdDr, b[e].custom6InputStdDr]).draw();
                ...
                open: function() {
                    ...
                    $("#tblStdDrAuswahl tbody").on("dblclick", "tr", function() {
                        var b = tblStdDrAuswahl.row(this).data()
                          ...
                          , f = a.slice(-1);
                        "stdDrSuchenExtDl" == e ? $("#standort" + f + "ExtDl").val(b[0]) : $("#standort" + f + "EngResExtDl").val(b[0]);
...
function bereichsAuswahllisteErstellen(a) {
    ("berSuchenVBereich1" == a.id || "berSuchenVBereich2" == a.id && 0 == $("#vorgelagerteBereiche2AllgemeinBer").prop("disabled") || "anlAuswahlBer" == a.id) && $.ajax({
        type: "POST",
        async: !0,
        url: "php/getBereiche.php",
        data: {
        ...
        success: function(b) {
            ...
            for (var e = 0; e < b.length; e++)
                tblBereichAussuchen.row.add([b[e].ber_ID, b[e].nameBer, b[e].kurzbezeichnungBer]).draw();
...
function messstellenAuswahllisteErstellen(a, b, e) {
    $.ajax({
        type: "POST",
        async: !0,
        url: "php/getMessstellen.php",
        ...
        success: function(b) {
            ...
            for (var c = 0; c < b.length; c++)
                tblMessstelleAuswahl.row.add([b[c].nameMSt, b[c].kurzbezeichnungMst, b[c].kostenstelleMst, b[c].messmittelBerechnungslogikMst, b[c].mst_ID]).draw();
            ...
            $("#messstellenAuswahlContainer").dialog({
                ...
                open: function() {
                    ...
                    $("#tblMessstellenlisteMst tbody").on("dblclick", "tr", function() {
                        ...
                        if ("vorgMst" == a)
                            $("#vorgelagerteMst").val(b[0]);
                        else if ("mstMsm" == a)
                            $("#messstelleAllgemeinMsm").val(b[0]),
                            $("#messstelleIDAllgemeinMsm").val(b[4]);
                        else if ("mstERng" == a)
                            $("#mstERng").val(b[0]),
                            $("#mstIDERng").val(b[4]),
                            $("#mstERng").trigger("change");
                            ...
                            $("#messstelle1ExtDl").val(b[0]);
                        else if ("mst2ExtDl" == a)
                            $("#messstelle2ExtDl").val(b[0]);
                        else if ("mst3ExtDl" == a)
                            $("#messstelle3ExtDl").val(b[0]);
                        else if ("mst4ExtDl" == a)
                            $("#messstelle4ExtDl").val(b[0]);
                        else if ("mst5ExtDl" == a)
                            $("#messstelle5ExtDl").val(b[0]);
                        else if ("mst6ExtDl" == a)
                            $("#messstelle6ExtDl").val(b[0]);
                        else if ("mstEngRes1ExtDl" == a)
                            $("#messstelleEngRes1ExtDl").val(b[0]);
                        else if ("mstEngRes2ExtDl" == a)
                            $("#messstelleEngRes2ExtDl").val(b[0]);
                        else if ("mstEngRes3ExtDl" == a)
                            $("#messstelleEngRes3ExtDl").val(b[0]);
                        else if ("mstEngRes4ExtDl" == a)
                            $("#messstelleEngRes4ExtDl").val(b[0]);
                        else if ("mstEngRes5ExtDl" == a)
                            $("#messstelleEngRes5ExtDl").val(b[0]);
                        else if ("mstEngRes6ExtDl" == a)
                            $("#messstelleEngRes6ExtDl").val(b[0]);
                        else if ("mstDiag1" == a)
                            $("#mstDiag1").val(b[0]),
                            $("#mstIDDiag1").val(b[4]);
                        else if ("mstDiag2" == a)
                            ...
                            $("#mstDiag3").val(b[0]),
                            $("#mstIDDiag3").val(b[4]);
                        else if ("mstCompDiag" == a)
                            $("#mstDiag").val(b[0]),
                            $("#mstIDDiag").val(b[4]);
                        else if ("mstDatenexport" == a)
                            $("#mstDatenexport").val(b[0]),
                            $("#mstIDDatenexport").val(b[4]);
                        else if ("mstSuchenVergl1" == a)
                            $("#vergMst1ERng").val(b[0]),
                            vergleichUpdaten("vergMst1ERng");
                        else if ("mstSuchenVergl2" == a)
                            $("#vergMst2ERng").val(b[0]),
                            vergleichUpdaten("vergMst2ERng");
...
function anlagenAuswahllisteErstellen(a, b) {
    $.ajax({
        type: "POST",
        async: !0,
        url: "php/getAnlagen.php",
        ...
        success: function(e) {
            ...
            for (var c = 0; c < e.length; c++)
                tblAnlagenII.row.add([e[c].nummerAnl, e[c].bezeichnungAnl, e[c].typAnl, e[c].custom1Anl, e[c].custom2Anl, e[c].custom3Anl, e[c].custom4Anl, e[c].custom5Anl, e[c].custom6Anl, e[c].anl_ID]).draw();
            ...
            $("#anlagenlisteAuswahlContainer").dialog({
                ...
                open: function() {
                    ...
                    $("#tblAnlagenListe2 tbody").on("dblclick", "tr", function() {
                        for (var c = tblAnlagenII.row(this).data(), e = []; e.length; )
                            e.pop();
                        e = a.split("Verbr");
                        "anlMsm" == a ? ($("#anlMsm").val(c[0] + " " + c[1]),
                        $("#anlIDMsm").val(c[9])) : "anlMst" == a ? ($("#anlMst").val(c[0] + " " + c[1]),
                        $("#anlIDMst").val(c[9])) : "imgBtnAnlage1Prd" == a ? ($("#inpAnlage1Prd").val(c[0] + " " + c[1]),
                        $("#inpAnlage1IDPrd").val(c[9])) : "imgBtnAnlage2Prd" == a ? ($("#inpAnlage2Prd").val(c[0] + " " + c[1]),
                        $("#inpAnlage2IDPrd").val(c[9])) : "imgBtnAnlage3Prd" == a ? ($("#inpAnlage3Prd").val(c[0] + " " + c[1]),
                        $("#inpAnlage3IDPrd").val(c[9])) : "imgBtnAnlage4Prd" == a ? ($("#inpAnlage4Prd").val(c[0] + " " + c[1]),
                        $("#inpAnlage4IDPrd").val(c[9])) : "imgBtnAnlage5Prd" == a ? ($("#inpAnlage5Prd").val(c[0] + " " + c[1]),
                        $("#inpAnlage5IDPrd").val(c[9])) : "imgBtnAnlage6Prd" == a ? ($("#inpAnlage6Prd").val(c[0] + " " + c[1]),
                        $("#inpAnlage6IDPrd").val(c[9])) : "imgBtnAnlage7Prd" == a ? ($("#inpAnlage7Prd").val(c[0] + " " + c[1]),
                        $("#inpAnlage7IDPrd").val(c[9])) : "imgBtnAnlage8Prd" == a ? ($("#inpAnlage8Prd").val(c[0] + " " + c[1]),
                        $("#inpAnlage8IDPrd").val(c[9])) : "imgBtnAnlage9Prd" == a ? ($("#inpAnlage9Prd").val(c[0] + " " + c[1]),
                        $("#inpAnlage9IDPrd").val(c[9])) : "imgBtnAnlage1PrdHist" == a ? $("#inpAnlage1PrdHist").val(c[0] + " " + c[1]) : "imgBtnAnlage2PrdHist" == a ? $("#inpAnlage2PrdHist").val(c[0] + " " + c[1]) : "imgBtnAnlage3PrdHist" == a ? $("#inpAnlage3PrdHist").val(c[0] + " " + c[1]) : "imgBtnAnlage4PrdHist" == a ? $("#inpAnlage4PrdHist").val(c[0] + " " + c[1]) : "imgBtnAnlage5PrdHist" == a ? $("#inpAnlage5PrdHist").val(c[0] + " " + c[1]) : "imgBtnAnlage6PrdHist" == a ? $("#inpAnlage6PrdHist").val(c[0] + " " + c[1]) : "imgBtnAnlage7PrdHist" == a ? $("#inpAnlage7PrdHist").val(c[0] + " " + c[1]) : "imgBtnAnlage8PrdHist" == a ? $("#inpAnlage8PrdHist").val(c[0] + " " + c[1]) : "imgBtnAnlage9PrdHist" == a ? $("#inpAnlage9PrdHist").val(c[0] + " " + c[1]) : 0 < e.length && "anlAuswahlZug" == e[0] ? ($("#zugeordneterVerbraucher" + e[1] + "AllgemeinAnl").val(c[0] + " " + c[1]),
                        $("#zugeordneterVerbraucherID" + e[1] + "AllgemeinAnl").val(c[9])) : "anlVorlFrm" == a && (e = "[" + (c[0] + "_" + c[1]).trim().replace(/\s/g, "_") + "]",
                        c = "anl_" + c[9],
                        $("#inpAuswahlVorlFrmIns" + b).val(e),
                        $("#inpAuswahlVorlFrmIDIns" + b).val(c));
...
function messmittelAuswahllisteErstellen(a) {
    $.ajax({
        type: "POST",
        async: !0,
        url: "php/getMessmittel.php",
        ...
        success: function(b) {
            ...
            for (var e = 0; e < b.length; e++)
                tblMessmittel.row.add([b[e].nrMsm, b[e].typNrMsm, b[e].anlageMsm, b[e].energietraegerMsm, b[e].msm_ID]).draw();
            ...
            $("#messmittelAuswahlContainer").dialog({
                ...
                open: function() {
                    ...
                    $("#tblMessmittel tbody").on("dblclick", "tr", function() {
                        var b = tblMessmittel.row(this).data();
                        "msmMst" == a && ($("#messmittelBerechnungslogikMst").val(b[0]),
                        $("#messmittelIDMst").val(b[4]),
                        sync.setCurrentLocation(CurrentLocation.MESSSTELLENVERWALTUNG),
                        sync.setIDMessstelle($("#mstID").val()),
                        sync.setIDMessmittel($("#messmittelIDMst").val()),
                        sync.synchronize());
...
function kanalauswahlTabelleErstellen(a) {
    $.ajax({
        type: "POST",
        async: !0,
        ...
        success: function(b) {
            ...
            for (var e = 0; e < b.length; e++)
                tblChannel.row.add([b[e].channel_id, b[e].description, b[e].name, b[e].phase]).draw();
...
function standorteAuswahllisteErstellen(a) {
    $.ajax({
        type: "POST",
        async: !0,
        url: "php/getStandorte.php",
        ...
        success: function(b) {
            ...
            for (var e = 0; e < b.length; e++)
                tblStandorteAuswahl.row.add([b[e].nameStd, b[e].kurzbezeichnungStd, b[e].flaecheStd]).draw();
...
function kennzahlenAuswahllisteErstellen(a) {
    $.ajax({
        type: "POST",
        async: !0,
        url: "php/readKennzahlen.php",
        ...
        success: function(b) {
            ...
            for (var e = 0; e < b.length; e++)
                tblKennzahlInstanzAuswahl.row.add([b[e].knzIns_ID, b[e].bezug, b[e].instanz, b[e].beschreibung]).draw();
            ...
            $("#kennzahlenAuswahlContainer").dialog({
                ...
                open: function() {
                    ...
                    $("#tblKennzahlInstanzAuswahl tbody").on("dblclick", "tr", function() {
                        ...
                        $.ajax({
                            ...
                            success: function(c) {
                                ...
                                for (var e = 0; e < c.length; e++)
                                    tblKennzahlAuswahl.row.add([c[e].knz_ID, c[e].bezeichnung, c[e].aktiv, c[e].anwendungsbereich, c[e].einheit, atob(c[e].formelString), c[e].kennzahl, c[e].grenzwertO, c[e].grenzwertU, c[e].zielwert, c[e].zielVon, c[e].zielBis]).draw();
                                $("#tblKennzahlAuswahl tbody tr").css("cursor", "pointer");
                                ...
                                $("#tblKennzahlAuswahl tbody").on("dblclick", "tr", function() {
                                    ...
                                    case "imgBtnknzDiag11":
                                        ...
                                        sessionStorage.setItem("knz_1_zielBis", c[11]);
                                        break;
    ...
    $.ajax({
        ...
        success: function(a) {
            ...
            for (i = 0; i < a.length; i++)
                tblAnlagen.column(i + 2).visible(!!+a[i]),
                $(".anlListeCheckboxes").eq(i).prop("checked", !!+a[i])
        }
    })
}
function anlagenfelderHinzufuegenProdukteverwaltung() {
    var a = {
    ...
    a.hidden && b.hidden ? a.show() : b.hidden ? b.show() : alert("Die maximale Anzahl an Anlagen ist erreicht!")
}
function diagrammGruppeHinzuf\u00fcgen() {
    tblGruppenDiag.row.add([$("#gruppeDiag").val()]).draw();
    $("#gruppeDiag").val("")
}
function toggleColumnsOnOff(a) {
    for (i = 0; i < tblAnlagen.columns().nodes().length; i++)
        $(tblAnlagen.column(i).header()).text() == $(a).prop("value") && tblAnlagen.column(i).visible($(a).is(":checked")),
        tblAnlagen.columns.adjust().draw()
}
function toggleExtDl(a) {
    1 == $(a).prop("checked") ? ($("#tabExtDl").css("display", "inline"),
    $("#tabStdDr").css("display", "inline")) : ($("#tabExtDl").css("display", "none"),
    $("#tabStdDr").css("display", "none"))
}
function toggleStandorteDritter(a) {
    1 == $(a).prop("checked") ? $(".stdDrExtDl").css("display", "inline") : ($(".stdDrExtDl").css("display", "none"),
    $(".stdDrExtDl input").val(""))
}
function toggleMandantOderMandantengruppe(a) {
    "Mandantengruppe" == a ? ($("#manGruppenForm").css("display", "block"),
    $("#navDropBoxManGrp img").css("display", "inline")) : ($("#manGruppenForm").css("display", "none"),
    $("#navDropBoxManGrp img").css("display", "none"))
}
function toggleLabelUndLadenSymbol() {
    "Anl" == $("#verwaltung").val() ? ladenSymbolID = "#ladenSymbolAnl, #ladenLblAnl" : "Msm" == $("#verwaltung").val() ? ladenSymbolID = "#ladenSymbolMsm, #ladenLblMsm" : "ERng" == $("#verwaltung").val() && (ladenSymbolID = "#ladenSymbolERng, #ladenLblERng");
...
function readinLevel(a) {
    $("#levelAllgemeinBer").val($(a).prop("value"))
}
function vorgelagertenBereichAktivieren(a) {
    "4.1-Umwandlungserzeuger-T1" == $(a).prop("value") || "4.2-Umwandlungserzeuger-T2" == $(a).prop("value") || "5-Wiedereinspeisepunkt" == $(a).prop("value") ? $("#vorgelagerteBereiche2AllgemeinBer").removeAttr("disabled") : ($("#vorgelagerteBereiche2AllgemeinBer").val(""),
    $("#vorgelagerteBereiche2AllgemeinBer").attr("disabled", "disabled"))
}
function createCustomField(a) {
    "std" == a ? "none" == $("#custom1Std").css("display") ? $("#custom1Std").css("display", "block") : "none" == $("#custom2Std").css("display") ? $("#custom2Std").css("display", "block") : "none" == $("#custom3Std").css("display") ? $("#custom3Std").css("display", "block") : "none" == $("#custom4Std").css("display") ? $("#custom4Std").css("display", "block") : "none" == $("#custom5Std").css("display") ? $("#custom5Std").css("display", "block") : "none" == $("#custom6Std").css("display") ? $("#custom6Std").css("display", "block") : ($("#meldungCustomFields").css("display", "block"),
    $("#meldungCustomFields").dialog()) : "none" == $("#" + a + "FaktorX1").css("display") ? $("#" + a + "FaktorX1").css("display", "block") : "none" == $("#" + a + "FaktorX2").css("display") ? $("#" + a + "FaktorX2").css("display", "block") : "none" == $("#" + a + "FaktorX3").css("display") ? $("#" + a + "FaktorX3").css("display", "block") : ($("#meldungCustomFields").css("display", "block"),
    $("#meldungCustomFields").dialog())
}
function messmittelOderBerechnungslogik(a) {
    "automatisch" == $(a).prop("value") || "manuell" == $(a).prop("value") ? ($("#labelMessmittelMst").css("display", "inline-block"),
    $("#labelBerechnungslogikMst").css("display", "none"),
    $("#linkBerechnungslogikOderEingabemaske").text("Messmittel anlegen")) : ($("#labelMessmittelMst").css("display", "none"),
    $("#labelBerechnungslogikMst").css("display", "inline-block"),
    $("#linkBerechnungslogikOderEingabemaske").text("Berechnungslogik anlegen"))
}
function umlauteZuErsatzzeichenKonvertieren(a) {
    a = a.replace(/\u00c4/g, "Ae");
    a = a.replace(/\u00e4/g, "ae");
    a = a.replace(/\u00d6/g, "Oe");
    a = a.replace(/\u00f6/g, "oe");
...
function dokumentAuswaehlenUndEinlesen(a) {
    a = a.target.files[0];
    var b = a.name
      , b = umlauteZuErsatzzeichenKonvertieren(b)
      , e = new FormData;
    e.append("file", a);
    e.append("fileName", b);
    e.append("nameDB", $("#nameDB").val());
    var c = !1
      , g = !1;
    if ("imgUploadAnl" == this.id)
        var f = "uploadsDownloads/php/uploadImage.php"
          , c = !0
          , g = "Anl";
    else
        "imgUploadMsm" == this.id ? (f = "uploadsDownloads/php/uploadImage.php",
        c = !0,
        g = "Msm") : "dokuAuswahlAnl" == this.id ? (e.append("id", $("#anlID").val()),
        e.append("verwaltung", "Anl"),
        e.append("kategorie", $("#kategorie").val()),
        f = "uploadsDownloads/php/upload.php") : "dokuAuswahlMsm" == this.id ? (e.append("id", $("#msmID").val()),
        e.append("verwaltung", "Msm"),
        e.append("kategorie", $("#kategorie").val()),
        f = "uploadsDownloads/php/upload.php") : "dokuAuswahlERng" == this.id && (e.append("id", $("#eRngID").val()),
        e.append("verwaltung", "ERng"),
        e.append("kategorie", $("#kategorie").val()),
        f = "uploadsDownloads/php/upload.php");
    var h = toggleLabelUndLadenSymbol();
    ...
    $.ajax({
        ...
        success: function(a) {
            $(h).css("display", "none");
            c && $("Anl" == g ? "#bildAllgemeinAnl" : "#bildAllgemeinMsm").prop("src", "uploadsDownloads/images/" + $("#nameDB").val() + "/" + a)
        }
    })
}
function dokumentAuswaehlenUndAuslesen(a, b) {
    $("#dokID").val(b);
    ...
    $.ajax({
        ...
        success: function(a) {
            ...
            $("#webViewerLink").prop("href", "uploadsDownloads/docs/" + $("#nameDB").val() + "/" + a);
...
function dokumenteLoeschen(a, b) {
    $.ajax({
...
function historieAendernFensterOeffnen(a) {
    $(a).dialog({
...
function datensatzAusHistorieEinlesenAnl(a) {
    $.ajax({
        ...
        success: function(a) {
            ...
            [["#anlIDHist", "anl_ID"], ["#idAllgemeinAnlHist", "anl_ID"], ["#bereichAllgemeinAnlHist", "nameBer"], ["#berIDHist", "ber_ID"], ["#anlagennummerAllgemeinAnlHist", "nummerAnl"], ["#bezeichnungAllgemeinAnlHist", "bezeichnungAnl"], ["#typAllgemeinAnlHist", "typAnl"], ["#serienNrAllgemeinAnlHist", "serienNrAnl"], ["#standortAllgemeinAnlHist", "standortAnl"], ["#baujahrAnlHist", "baujahrAnl"], ["#datumAnschaffungAllgemeinAnlHist", "datumAnschaffungAnl"], ["#betriebsstundenAllgemeinAnlHist", "jahresbetriebsstundenAnl"], ["#notizAllgemeinAnlHist", "notizAnl"], ["#gueltigVonAnlHist", "gueltigVonAnl"], ["#gueltigBisAnlHist", "gueltigBisAnl"], ["#produktAllgemeinAnlHist", "produktAnl"], ["#produktionsmenge1AllgemeinAnlHist", "produktionsmengeAnl"], ["#einheitProduktionsmenge1AllgemeinAnlHist", "produktionsmengeEinheitAnl"], ["#produktnummer1AllgemeinAnlHist", "produktnummerAnl"], ["#zugeordneterVerbraucher1AllgemeinAnlHist", "zugeordneterVerbraucher1"], ["#zugeordneterVerbraucher2AllgemeinAnlHist", "zugeordneterVerbraucher2"], ["#zugeordneterVerbraucher3AllgemeinAnlHist", "zugeordneterVerbraucher3"], ["#zugeordneterVerbraucher4AllgemeinAnlHist", "zugeordneterVerbraucher4"], ["#zugeordneterVerbraucher5AllgemeinAnlHist", "zugeordneterVerbraucher5"], ["#zugeordneterVerbraucher6AllgemeinAnlHist", "zugeordneterVerbraucher6"], ["#energietraeger1AllgemeinAnlHist", "energietraeger1Anl"], ["#energieform1AllgemeinAnlHist", "energieform1Anl"], ["#einheit1AnlHist", "einheitEnergie1Anl"], ["#anschlussleistung1AnlHist", "anschlussleistung1Anl"], ["#mittlereAuslastungProzent1AnlHist", "mittlereAuslastungProzent1Anl"], ["#mittlereAuslastungKw1AnlHist", "mittlereAuslastungKw1Anl"], ["#betriebstemperatur1AnlHist", "betriebstemperatur1Anl"], ["#mst1AnlHist", "messstelle1Anl"], ["#ber1AnlHist", "versBereich1Anl"], ["#abwaerme1AnlHist", "abwaerme1Anl"], ["#nutzbarkeitAbwaerme1AnlHist", "abwaermeNutzbarkeit1Anl"], ["#bewertungNutzbarkeitAbwaerme1AnlHist", "bewertungNutzbarkeitAbwaerme1Anl"], ["#energietraeger2AllgemeinAnlHist", "energietraeger2Anl"], ["#energieform2AllgemeinAnlHist", "energieform2Anl"], ["#einheit2AnlHist", "einheitEnergie2Anl"], ["#anschlussleistung2AnlHist", "anschlussleistung2Anl"], ["#mittlereAuslastungProzent2AnlHist", "mittlereAuslastungProzent2Anl"], ["#mittlereAuslastungKw2AnlHist", "mittlereAuslastungKw2Anl"], ["#betriebstemperatur2AnlHist", "betriebstemperatur2Anl"], ["#mst2AnlHist", "messstelle2Anl"], ["#ber2AnlHist", "versBereich2Anl"], ["#abwaerme2AnlHist", "abwaerme2Anl"], ["#nutzbarkeitAbwaerme2AnlHist", "abwaermeNutzbarkeit2Anl"], ["#bewertungNutzbarkeitAbwaerme2AnlHist", "bewertungNutzbarkeitAbwaerme2Anl"], ["#energietraeger3AllgemeinAnlHist", "energietraeger3Anl"], ["#energieform3AllgemeinAnlHist", "energieform3Anl"], ["#einheit3AnlHist", "einheitEnergie3Anl"], ["#anschlussleistung3AnlHist", "anschlussleistung3Anl"], ["#mittlereAuslastungProzent3AnlHist", "mittlereAuslastungProzent3Anl"], ["#mittlereAuslastungKw3AnlHist", "mittlereAuslastungKw3Anl"], ["#betriebstemperatur3AnlHist", "betriebstemperatur3Anl"], ["#mst3AnlHist", "messstelle3Anl"], ["#ber3AnlHist", "versBereich3Anl"], ["#abwaerme3AnlHist", "abwaerme3Anl"], ["#nutzbarkeitAbwaerme3AnlHist", "abwaermeNutzbarkeit3Anl"], ["#bewertungNutzbarkeitAbwaerme3AnlHist", "bewertungNutzbarkeitAbwaerme3Anl"], ["#energietraeger4AllgemeinAnlHist", "energietraeger4Anl"], ["#energieform4AllgemeinAnlHist", "energieform4Anl"], ["#einheit4AnlHist", "einheitEnergie4Anl"], ["#anschlussleistung4AnlHist", "anschlussleistung4Anl"], ["#mittlereAuslastungProzent4AnlHist", "mittlereAuslastungProzent4Anl"], ["#mittlereAuslastungKw4AnlHist", "mittlereAuslastungKw4Anl"], ["#betriebstemperatur4AnlHist", "betriebstemperatur4Anl"], ["#mst4AnlHist", "messstelle4Anl"], ["#ber4AnlHist", "versBereich4Anl"], ["#abwaerme4AnlHist", "abwaerme4Anl"], ["#nutzbarkeitAbwaerme4AnlHist", "abwaermeNutzbarkeit4Anl"], ["#bewertungNutzbarkeitAbwaerme4AnlHist", "bewertungNutzbarkeitAbwaerme4Anl"], ["#custom1AnlHist", "custom1Anl"], ["#custom2AnlHist", "custom2Anl"], ["#custom3AnlHist", "custom3Anl"], ["#custom4AnlHist", "custom4Anl"], ["#custom5AnlHist", "custom5Anl"], ["#custom6AnlHist", "custom6Anl"]].forEach(function(a) {
                $(a[0]).val(b[0][a[1]])
            })
        }
    })
}
function datensatzAusHistorieEinlesenPrd(a) {
    $.ajax({
        url: "php/getHistorieDatensatz.php",
        type: "POST",
        data: {
        ...
        success: function(a) {
            ...
            [["#bezeichnungPrdHist", "namePrd"], ["#artklnrPrdHist", "artikelNrPrd"], ["#custom1PrdHist", "custom1"], ["#custom2PrdHist", "custom2"], ["#custom3PrdHist", "custom3"], ["#custom4PrdHist", "custom4"], ["#custom5PrdHist", "custom5"], ["#custom6PrdHist", "custom6"], ["#inpAnlage1PrdHist", "anl1"], ["#gueltigVon1PrdHist", "gueltigVon1"], ["#gueltigBis1PrdHist", "gueltigBis1"], ["#inpAnlage2PrdHist", "anl2"], ["#gueltigVon2PrdHist", "gueltigVon2"], ["#gueltigBis2PrdHist", "gueltigBis2"]["#inpAnlage3PrdHist",
            "anl3"], ["#gueltigVon3PrdHist", "gueltigVon3"], ["#gueltigBis3PrdHist", "gueltigBis3"]["#inpAnlage4PrdHist",
            "anl4"], ["#gueltigVon4PrdHist", "gueltigVon4"], ["#gueltigBis4PrdHist", "gueltigBis4"]["#inpAnlage5PrdHist",
            "anl5"], ["#gueltigVon5PrdHist", "gueltigVon5"], ["#gueltigBis5PrdHist", "gueltigBis5"]["#inpAnlage6PrdHist",
            "anl6"], ["#gueltigVon6PrdHist", "gueltigVon6"], ["#gueltigBis6PrdHist", "gueltigBis6"]["#inpAnlage7PrdHist",
            "anl7"], ["#gueltigVon7PrdHist", "gueltigVon7"], ["#gueltigBis7PrdHist", "gueltigBis7"]["#inpAnlage8PrdHist",
            "anl8"], ["#gueltigVon8PrdHist", "gueltigVon8"], ["#gueltigBis8PrdHist", "gueltigBis8"]["#inpAnlage9PrdHist",
            "anl9"], ["#gueltigVon9PrdHist", "gueltigVon9"], ["#gueltigBis9PrdHist", "gueltigBis9"]].forEach(function(a) {
                $(a[0]).val(b[0][a[1]])
            })
        }
    })
}
function verbrauchBerechnen(a, b, e, c) {
    $.ajax({
        type: "POST",
        async: !0,
        ...
        success: function(b) {
            b = json(b);
            var f;
            0 < b.length && (e == b[0].einheit1Ent ? f = b[0].entEinh1FaktorKwh : e == b[0].einheit2Ent ? f = b[0].entEinh2FaktorKwh : e == b[0].einheit3Ent && (f = b[0].entEinh3FaktorKwh),
            -1 != c.indexOf(",") && (c = formatNumber("deform", c)),
            f *= c,
            f = f.toFixed(2),
            "mengeERng" == a || "einERng" == a) && ($("#mengeERng").val(formatNumber("form", c)),
            $("#verbrauchERng").val(formatNumber("form", f)))
        }
    })
}
function einheitenEntEinlesen(a) {
    $.ajax({
        type: "POST",
        async: !0,
        ...
        success: function(a) {
            a = json(a);
            $("#einERng").empty();
            0 < a.length && ("" != a[0].einheit1Ent && null != a[0].einheit1Ent && $("#einERng").append("<option>" + a[0].einheit1Ent + "</option>"),
            "" != a[0].einheit2Ent && null != a[0].einheit2Ent && $("#einERng").append("<option>" + a[0].einheit2Ent + "</option>"),
            "" != a[0].einheit3Ent && null != a[0].einheit3Ent && $("#einERng").append("<option>" + a[0].einheit3Ent + "</option>"))
        }
    })
}
function letzteRechnungenInTbl(a) {
    $.ajax({
        type: "POST",
        async: !0,
        ...
        success: function(a) {
            ...
            for (i = 0; i < a.length; i++)
                b = a[i].vomERng + "-" + a[i].bisERng,
                c = a[i].verbrauchERng,
                c = formatNumber("form", c),
                tblLetzteRechnungen.row.add([b, c]).draw()
        }
    })
}
    ...
    $("#zugangOk").on("click", function() {
        $.ajax({
            ...
            success: function(a) {
                ...
                b.trim();
                b == a ? ($("#tabGipscAdm").css("background-color", "#CED6DE"),
                $("#infosGipscommAdmins").css("display", "block"),
                $("#activeInstance").val("gipscAdm"),
                $("#gipscAdmZugang").dialog("close")) : (alert("Das Passwort ist falsch!"),
...
function SpaEfVTbl1Erstellen(a, b, e, c) {
    $.ajax({
        type: "POST",
        async: !0,
        ...
        success: function(b) {
            ...
            b = JSON.stringify(b);
            var e;
            e = 1 == $(".spaEfvJahreAuswahl[checked=true]").length ? !0 : !1;
...
function SpaEfVTbl2Erstellen(a, b, e, c) {
    $.ajax({
        type: "POST",
        async: !0,
    ...
    $.ajax({
        ...
        success: function(b) {
            b = json(b);
            "gesamt" == a ? instanzName = 1 == $("#orgCount").val() ? $(".orgPfad").val() : $(".manPfad").val() : "organisation" == a ? instanzName = $(".orgPfad").val() : "liegenschaft" == a && (instanzName = $(".liegPfad").val());
            b = JSON.stringify(b);
...
function getVersionSpaEfV(a) {
    var b;
    $("#basisSpaEfVTbl" + a).prop("checked") ? b = "basis" : $("#benutzerdefiniertSpaEfVTbl" + a).prop("checked") ? b = "benutzerdefiniert" : alert("getting the SpaEfV version failed!! :func getVersionSpaEfV(tabelle)");
    return b
}
function detailAuswahlAnzeigenSpaEfV(a, b) {
    var e;
    e = a ? "inline" : "none";
    $(".spaEfVBenutzerdefiniert" + b).css("display", e)
}
function getVerdichtungSpaEfV(a) {
    var b;
    1 == a ? $("#entsVerdichtetSpaEfVTbl1").prop("checked") ? b = "verdichtet" : $("#entsUnverdichtetSpaEfVTbl1").prop("checked") && (b = "unverdichtet") : 2 == a ? $("#entsVerdichtet1SpaEfVTbl2").prop("checked") ? b = "verdichtet1" : $("#entsVerdichtet2SpaEfVTbl2").prop("checked") ? b = "verdichtet2" : $("#entsUnverdichtetSpaEfVTbl2").prop("checked") && (b = "unverdichtet") : alert("getting the SpaEfV verdichtung failed!! :func getVerdichtungSpaEfV(tabelle)");
    return b
}
function getRechnungsjahre(a) {
    $.ajax({
        type: "POST",
        async: !0,
        ...
        success: function(a) {
            ...
            for (var c = 0; c < a.length; c++)
                b = "<input class='spaEfvJahreAuswahl' type='checkbox'/><label>" + a[c].Jahr + "</label><br>",
                $("#jahreSpaEfVBenutzerdef").append(b)
        }
    })
}
...
function getJahresstringBenutzerdefSpaEfV1(a, b) {
    var e = $(".spaEfvJahreAuswahl")
      ...
      , h = "";
    if ("basis" == a)
        h += "Jahr > RIGHT(CONVERT(varchar(20), getdate(), 104), 4) - 5 ";
    else if ("benutzerdefiniert" == a)
        if ("letzte5" == b)
            h += "Jahr > RIGHT(CONVERT(varchar(20), getdate(), 104), 4) - 5 ";
        else if ("benutzerdefJahre" == b)
            for (var q = 0; q < g; q++)
                e.eq(q).prop("checked") && f ? (h += "Jahr = '" + c.eq(q).text() + "' ",
                f = !1) : e.eq(q).prop("checked") ? h += "OR Jahr = '" + c.eq(q).text() + "' " : e.eq(q).prop("checked") && alert("getting the SpaEfV Benutzerdefinierte Jahre failed!! :func getJahresstringSpaEfVBenutzerdef()");
        else
...
function vergleichUpdaten(a) {
    var b = [], e = 0, c = 0, g, f, h;
    "jahr1ERng" == a || "monate1ERng" == a || "vergEnt1ERng" == a || "vergMst1ERng" === a ? (h = tblAuswertung1ERng,
    b = [$("#jahr1ERng"), $("#monate1ERng"), $("#vergEnt1ERng"), $("#vergMst1ERng")],
    g = $("#summeVerbr1ERng"),
    f = $("#summeKosten1ERng")) : (h = tblAuswertung2ERng,
...
function formatNumber(a, b) {
    ...
    if ($.isNumeric(b) || void 0 != b) {
        ...
        var g = 0;
        if ("form" == a) {
            for (k = e[0].length - 1; -1 < k; k--)
                g++,
                3 == g && 0 != k ? (c = "." + e[0].charAt(k) + c,
                g = 0) : e[0].charAt(0) && (c = e[0].charAt(k) + c);
...
function versorgerUndEinheitBefuellen() {
    ...
    $.ajax({
        ...
        success: function(a) {
            ...
            0 < a.length && ("" != a[0].versorgerEvu && $("#versorgerERng, #versorgerIMw").append("<option selected>" + a[0].versorgerEvu + "</option>"),
            "" != a[0].versorgerUenb && $("#versorgerERng, #versorgerIMw").append("<option>" + a[0].versorgerUenb + "</option>"),
            "" != a[0].versorgerMsb && $("#versorgerERng, #versorgerIMw").append("<option>" + a[0].versorgerMsb + "</option>"),
            "" != a[0].einheit1Ent && $("#einERng").append("<option selected>" + a[0].einheit1Ent + "</option>"),
            "" != a[0].einheit2Ent && $("#einERng").append("<option>" + a[0].einheit2Ent + "</option>"),
            "" != a[0].einheit3Ent && $("#einERng").append("<option>" + a[0].einheit3Ent + "</option>"))
        }
    })
}
var mandantenliste = [];
function mandant(a, b, e) {
    this.nameDB = a;
    this.manID = b;
    this.name = e
}
function processLoginInfo() {
    function a(a, e, c) {
        $.ajax({
            ...
            success: function(a) {
                ...
                $(".manPfad").empty();
                for (var b = 0; b < a.length; b++)
                    mandantenliste[b] = new mandant(a[b].dbName,a[b].man_ID,a[b].nameMan),
                    $(".manPfad").append("<option>" + mandantenliste[b].name + "</option>");
    ...
    "gipsAdm" == sessionStorage.getItem("position") ? a("alle", null, null) : "sAdm" == sessionStorage.getItem("position") ? ($("#betrGrpMenuLi, #sAdmMenuLi").css("display", "none"),
    $("#tabBetrGrp, #tabGipscAdm").css("display", "none"),
    $("#betrGrpID").val(sessionStorage.getItem("betrGrp_ID")),
    a($("#betrGrpID").val(), null, null)) : "adm" == sessionStorage.getItem("position") ? ($("#betrGrpMenuLi, #sAdmMenuLi, #manGrpMenuLi, #admMenuLi").css("display", "none"),
    $("#tabGipscAdm, #tabBetrGrp, #tabManGrp, #tabAdm").css("display", "none"),
    $.isNumeric(sessionStorage.getItem("man_ID")) ? a(null, "man_ID", sessionStorage.getItem("man_ID")) : $.isNumeric(sessionStorage.getItem("manGrp_ID")) && a(null, "manGrp_ID", sessionStorage.getItem("manGrp_ID")),
    readInstanzen("manFirst", 0)) : "ben" == sessionStorage.getItem("position") && ($("#rechtMenuLi").css("display", "none"),
    $.isNumeric(sessionStorage.getItem("man_ID")) ? a(null, "man_ID", sessionStorage.getItem("man_ID")) : $.isNumeric(sessionStorage.getItem("manGrp_ID")) && a(null, "manGrp_ID", sessionStorage.getItem("manGrp_ID")),
...
function betrGrpInDropbox(a) {
    $(".betrPfad").empty();
    for (n = 0; n < a.length; n++)
        betrGrpListe[n] = new betrGrp(a[n].firma,a[n].betrGrp_ID),
...
function organisationenEinlesen() {
    ...
    /* Here changed the database name concept old one commented - 22/01/2020*/
    var a = $("#nameDB").val();
    ajaxPost("php/organisationenEinlesen.php")({
        nameDB: a
    }).then(function(a) {
...
function liegenschaftenInDropbox(a) {
    $(".liegPfad").empty();
    liegenschaftenliste = [];
    liegenschaft.Name = "";
    liegenschaft.LiegID = "";
    for (var b = 0; b < a.length; b++)
        liegenschaft.Name = a[b].nameLieg,
        liegenschaft.LiegID = a[b].lieg_ID,
        liegenschaftenliste[b] = liegenschaft,
        $(".liegPfad").append("<option>" + liegenschaftenliste[b].Name + "</option>")
}
var bereicheliste = []
...
function bereicheAnzeigenEinlesen(a) {
    $.ajax({
        type: "POST",
        async: !0,
        url: "php/getBereiche.php",
...
function bereicheInTabelle(a, b) {
    $("#bereichWaehlen tr").not("#bereichWaehlen tr:nth-child(1)").remove();
    bereicheliste = [];
    for (var e = 0; e < b.length; e++) {
        bereicheliste[e] = new Bereich(b[e].nameOrg,b[e].nameLieg,b[e].nameBer,b[e].ber_ID);
    ...
    $("#bereichWaehlen").dialog({
        ...
        open: function() {
            ...
            $("#berSuchenAnl, #berResetAnl").click(function() {
                if ("berResetAnl" != this.id)
                    var b = $("#sucheBereichAnl").val();
                else
                    $("#sucheBereichAnl").val(""),
                    b = "";
                ...
                for (var c = 0; c < bereicheliste.length; c++) {
                    ...
                    if (-1 != r || -1 != e || -1 != q || "" == b)
                        r = "<tr class='bereichX'>",
                        r += "<td>" + bereicheliste[c].nameOrg + "</td>",
                        r += "<td>" + bereicheliste[c].nameLieg + "</td>",
                        r += "<td>" + bereicheliste[c].nameBer + "</td>",
                        r += "<td style='display:none;'>" + bereicheliste[c].berID + "</td>",
                        r += "</tr>",
                        $("#tblBereicheAnl tbody").append(r);
...
function dbFuerEnergietraegerFestlegen(a) {
    entDB = "Global" == a ? "gipscomm" : $("#nameDB").val()
}
function energietrInDBoxBer() {
    $(".entBer option").remove();
    for (i = 1; 5 > i; i++)
        null != $("#energietraeger" + i + "Lieg").val() && $(".entBer").append("<option>" + $("#inputEnergietraeger" + i + "Lieg").val() + "</option>")
}
function energietrInDBoxLieg() {
    $.ajax({
        ...
        success: function(a) {
            ...
            for (i = 0; i < a.length; i++)
                $(".energietraegerLieg").append("<option>" + a[i].nameEnt + "</option>");
            energietrInDBoxBer()
        }
    })
}
            ...
            for (var b, e = [], c = "<option></option>", g = 0; g < a.length; g++) {
                ...
                if (!b) {
                    ...
                    for (b = 0; b < a.length; b++)
                        a[b].allgemeinerEnt == a[g].allgemeinerEnt && (c += "<option>" + a[b].nameEnt + "</option>");
                    c += "</optgroup>"
                }
            }
...
function energiefrmInDBoxLieg() {
    $.ajax({
        ...
        success: function(a) {
            ...
            for (i = 0; i < a.length; i++)
                1 == a[i].aktivEnf && $(".energieformenLieg").append("<option>" + a[i].nameEnf + "</option>")
        }
    })
}
function energieformenEinAusblenden() {
    "block" == $("#interneEnergieformenLieg").css("display") ? ($("#interneEnergieformenLieg select").val(""),
    $("#interneEnergieformenLieg").css("display", "none")) : $("#interneEnergieformenLieg").css("display", "block")
}
        ...
        success: function(a) {
            ...
            for (i = 0; i < a.length; i++) {
                ...
                for (j = 0; j < b.length; j++)
                    $("#custom" + (i + 1) + "Anl").append("<option>" + b[j] + "</option>")
            }
        }
    })
}
function erweiterungenProdukteEinlesen() {
    $.ajax({
        type: "POST",
        async: !0,
        ...
        success: function(a) {
            ...
            for (i = 0; i < a.length; i++) {
                $("#lblCustom" + (i + 1) + "Prd, #lblCustom" + (i + 1) + "PrdKnz").text(a[i].name);
                var b = a[i].optionen.split(",");
                $("#custom" + (i + 1) + "Prd").empty();
                for (j = 0; j < b.length; j++)
                    $("#custom" + (i + 1) + "Prd").append("<option>" + b[j] + "</option>")
            }
        }
    })
}
    ...
    $.ajax({
        ...
        success: function(h) {
            ...
            for (var r = 0; r < q; r++)
                a = String(h[r].mst_ID),
                a = a.replace(/^\s+|\s+$/gm, ""),
                b = String(h[r].nameMSt),
                b = "[" + b.replace(/^\s+|\s+$/gm, "") + "]",
                b = String(b.replace(/\s/g, "_")),
                e = String(h[r].kurzbezeichnungMst),
                e = e.replace(/^\s+|\s+$/gm, ""),
                c = String(h[r].energietraegerMst),
                c = c.replace(/^\s+|\s+$/gm, ""),
                g = String(h[r].messartMst),
                g = g.replace(/^\s+|\s+$/gm, ""),
                f = String(h[r].anlageMst),
                f = f.replace(/^\s+|\s+$/gm, ""),
...
function anlagenInAuswertungsEditorTabelleEinlesen() {
    var a = ""
      , b = "";
    $.ajax({
        type: "POST",
        ...
        success: function(e) {
            ...
            for (var g = 0; g < c; g++)
                a = String(e[g].anl_ID),
                a = a.replace(/^\s+|\s+$/gm, ""),
                b = String(e[g].nummerAnl + "_" + e[g].bezeichnungAnl),
                b = "[" + b.replace(/^\s+|\s+$/gm, "") + "]",
                b = String(b.replace(/\s/g, "_")),
                typ = String(e[g].typAnl),
                typ = typ.replace(/^\s+|\s+$/gm, ""),
                standort = String(e[g].standortAnl),
                standort = standort.replace(/^\s+|\s+$/gm, ""),
                baujahr = String(e[g].baujahrAnl),
                baujahr = baujahr.replace(/^\s+|\s+$/gm, ""),
                tblAnlagenBerechnungseditor.row.add([a + " ", b + " ", typ + " ", standort + " ", baujahr]).draw(),
                $("tr").css("cursor", "pointer")
        }
    })
}
function produkteInFormeleditorEinlesen() {
    $.ajax({
        type: "POST",
        async: !0,
        ...
        success: function(a) {
            ...
            for (var e = 0; e < b; e++)
                tblProdukte.row.add([a[e].ePrd_ID + " ", "[" + a[e].name + "]", "  ", a[e].beschreibung + " ", a[e].optionen + " "]).draw(),
                $("tr").css("cursor", "pointer")
        }
    })
}
function dynBdeDatenInAuswertungsEditorTabelleEinlesen() {
    var a = function(a) {
        return function(b) {
    ...
    $.ajax({
        ...
        success: function(a) {
            ...
            for (var f = 0; f < e; f++)
                "true" === a[f][3][1] && (tblBdeDynBerechnungseditor.row.add([a[f][0][1] + "-" + a[f][2][1] + " ", "[" + a[f][4][1].replace(/\s/g, "_") + "]", a[f][1][1] + " "]).draw(),
                $("tr").css("cursor", "pointer"))
        }
    })
}
...
function anlagenHistorieInTabelleEinlesen() {
    $.ajax({
        ...
        success: function(a) {
            ...
            for (var e = 0; e < b; e++)
                tblHistorieAnl.row.add([a[e].anl_ID, e + 1, a[e].AnlagenNr, a[e].Bezeichnung, a[e].Datum, a[e].Info, a[e].Bemerkung]).draw(),
                tblHistorieAnl.column(0).visible(!1),
                $("#tblHistorieAnl tr").css("cursor", "pointer"),
                $("#tblHistorieAnl").off("dblclick", "tr"),
                $("#tblHistorieAnl").on("dblclick", "tr", function() {
...
function produkteHistorieInTabelleEinlesen() {
    $.ajax({
        type: "POST",
        async: !0,
        url: "php/getHistorie.php",
        ...
        success: function(a) {
            ...
            for (var e = 0; e < b; e++)
                tblHistoriePrd.row.add([a[e].prd_ID, a[e].ArtikelNr, a[e].Produktbezeichnung, a[e].Datum, a[e].Info, a[e].Bemerkung]).draw(),
                tblHistoriePrd.column(0).visible(!1),
                $("#tblHistoriePrd tr").css("cursor", "pointer"),
                $("#tblHistoriePrd").off("dblclick", "tr"),
                $("#tblHistoriePrd").on("dblclick", "tr", function() {
...
function knzEinheitenEinlesen() {
    $.ajax({
        ...
        success: function(a) {
            ...
            for (var e = 0; e < b; e++)
                tblEinheitenKnzs.row.add([a[e].name]).draw(),
                $("tr").css("cursor", "pointer")
        }
    })
}
...
function mandantenInMandantenGruppenTabelleEinlesen(a) {
    ...
    $.ajax({
        ...
        success: function(a) {
            ...
            if (0 < a.length)
                for (n = 0; n < a.length; n++)
                    tblMandantengruppe.row.add([a[n].man_ID, a[n].nameMan, a[n].dbName], n).draw(),
                    tblMandantengruppe.column(0).visible(!1).draw();
            else
                tblMandantengruppe.clear().draw()
        }
...
function formelerweiterungNachDrop(a, b, e, c) {
    c = null;
    c = "none" == $("#tblIMwContainer").css("display") ? new MeasurementPoint(b,e,0) : new Machine(b,e,0);
    ...
    $("#formelStringDarstellung").val($("#formelStringDarstellung").val() + e),
    $("#formelIdDarstellung").val($("#formelIdDarstellung").val() + b)) : ($("#berechneteMstName").val(e),
    $("#berechneteMstID").val(b),
    formula.resetFormula(),
    $("#formelStringDarstellung").val(""),
    $("#formelIdDarstellung").val(""),
    formula.setMeasurementObjectToCalculate(c),
    $("#formelStringDarstellung").val(formula.getMeasurementObjectToCalculate().name + " = "),
    "" != b ? ($("#berechneteMstName").val(e),
    $("#berechneteMstID").val(b),
    formula.readFromDB(DbTable.MESSSTELLEN).then(function(a) {
...
var masseneingabe = new MassInputMatrix
  , ME = masseneingabe;
function masseneingabeTageEinlesen(a) {
    ME.resetObj();
    ...
    for (var r = 0; r < c.length; r++)
        for (var x = 0; x < c[r].days; x++)
            g = getWeekday(b, r, x + 1),
            g = "Samstag" == g || "Sonntag" == g ? "<label data-month='" + r + "' style='display:inline-block;width:120px;color: gray'>" + (x + 1) + " " + c[r].month + ". " + g + "</label>" : "<label data-month='" + r + "' style='display:inline-block;width:120px;'>" + (x + 1) + " " + c[r].month + ". " + g + "</label>",
            f += "<input data-month='" + r + "' style='display:inline-block;width:116px;' />",
            $("#masseneingabeZeitintervallIMw").append(g),
            e++;
    $("#masseneingabeZeitintervallIMw").append("<br>");
    a == InstanceMode.ENERGY ? q = "SELECT masseneingabeTage.mst_ID, nameMSt FROM masseneingabeTage INNER JOIN messstellen ON masseneingabeTage.mst_ID = messstellen.mst_ID " + ("WHERE year = '" + $("#jahrMasseneingabeIMw").val() + "' ") : a == InstanceMode.BDE && (q = "SELECT masseneingabeTage.anl_ID, bezeichnungAnl, nummerAnl FROM masseneingabeTage INNER JOIN anlagen ON masseneingabeTage.anl_ID = anlagen.anl_ID " + ("WHERE year = '" + $("#jahrMasseneingabeIMw").val() + "' "),
    q += "AND einheit = '" + $("#einheitMasseneingabeIMw").val() + "' ");
    (new DataMachine).runQuery("read", $("#nameDB").val(), q).then(function(a) {
        a = json(a);
        for (var b = [], c, e = 0; e < a.length; e++)
            $("#masseneingabeInputIMw").append("<div data-row='" + (e + 1) + "'>" + f + "</div>"),
            ME.getModusEngOrBde() == InstanceMode.ENERGY ? (h += "<input name='" + (e + 1) + "' readonly style='display:inline-block;width:140px;background-color: transparent;border-color: transparent;' value='" + a[e].nameMSt + "'/><br>",
            b.push(new MeasurementPoint(a[e].mst_ID,a[e].nameMSt,366))) : ME.getModusEngOrBde() == InstanceMode.BDE && (c = $("#btnAnlagenNummerMassEing").is(":checked") ? a[e].nummerAnl : a[e].bezeichnungAnl,
            h += "<input name='" + (e + 1) + "' readonly style='display:inline-block;width:140px;background-color: transparent;border-color: transparent;' value='" + c + "'/><br>",
            b.push(new Machine(a[e].anl_ID,c,366)));
        $("#masseneingabeNameIMw").append(h);
        ME.setMeasurementObjects(b)
    })
}
function masseneingabeWochenEinlesen(a) {
    ME.resetObj();
    ...
    $("#masseneingabeZeitintervallIMw label, #masseneingabeZeitintervallIMw br, #masseneingabeNameIMw input, #masseneingabeNameIMw br, #masseneingabeInputIMw input, #masseneingabeInputIMw div, #masseneingabeInputIMw br").remove();
    for (var h = 0; 52 > h; h++)
        e = "<label style='display:inline-block;width:120px;'>" + (h + 1) + "-KW</label>",
        c += "<input style='display:inline-block;width:116px;' />",
        $("#masseneingabeZeitintervallIMw").append(e);
    $("#masseneingabeZeitintervallIMw").append("<br>");
    a == InstanceMode.ENERGY ? f = "SELECT masseneingabeWochen.mst_ID, nameMSt FROM masseneingabeWochen INNER JOIN messstellen ON masseneingabeWochen.mst_ID = messstellen.mst_ID " + ("WHERE year = '" + b + "' ") : a == InstanceMode.BDE && (f = "SELECT masseneingabeWochen.anl_ID, bezeichnungAnl, nummerAnl FROM masseneingabeWochen INNER JOIN anlagen ON masseneingabeWochen.anl_ID = anlagen.anl_ID " + ("WHERE year = '" + b + "' ") + ("AND einheit = '" + $("#einheitMasseneingabeIMw").val() + "' "));
    (new DataMachine).runQuery("read", $("#nameDB").val(), f).then(function(a) {
        a = json(a);
        for (var b = [], e, f = 0; f < a.length; f++)
            $("#masseneingabeInputIMw").append("<div data-row='" + (f + 1) + "'>" + c + "</div>"),
            ME.getModusEngOrBde() == InstanceMode.ENERGY ? (g += "<input name='" + (f + 1) + "' readonly style='display:inline-block;width:140px;background-color: transparent;border-color: transparent;' value='" + a[f].nameMSt + "'/><br>",
            b.push(new MeasurementPoint(a[f].mst_ID,a[f].nameMSt,52))) : ME.getModusEngOrBde() == InstanceMode.BDE && (e = $("#btnAnlagenNummerMassEing").is(":checked") ? a[f].nummerAnl : a[f].bezeichnungAnl,
            g += "<input name='" + (f + 1) + "' readonly style='display:inline-block;width:140px;background-color: transparent;border-color: transparent;' value='" + e + "'/><br>",
            b.push(new Machine(a[f].anl_ID,e,52)));
        $("#masseneingabeNameIMw").append(g);
        ME.setMeasurementObjects(b)
    })
}
function masseneingabeMonateEinlesen(a) {
    ME.resetObj();
    ...
    $("#masseneingabeZeitintervallIMw label, #masseneingabeZeitintervallIMw br, #masseneingabeNameIMw input, #masseneingabeNameIMw br, #masseneingabeInputIMw input, #masseneingabeInputIMw div, #masseneingabeInputIMw br").remove();
    for (var e = 0; e < nMonth; e++)
        labelString = "<label style='display:inline-block;width:120px;'>" + monthArray[e] + "</label>",
        inputString += "<input style='display:inline-block;width:116px;' />",
        $("#masseneingabeZeitintervallIMw").append(labelString);
    $("#masseneingabeZeitintervallIMw").append("<br>");
    a == InstanceMode.ENERGY ? (queryString = "SELECT masseneingabeMonate.mst_ID, nameMSt FROM masseneingabeMonate ",
    queryString += "INNER JOIN messstellen ",
    queryString += "ON masseneingabeMonate.mst_ID = messstellen.mst_ID ",
    ...
    queryString += "WHERE year = '" + b + "' ",
    queryString += "AND einheit = '" + $("#einheitMasseneingabeIMw").val() + "' ");
    (new DataMachine).runQuery("read", $("#nameDB").val(), queryString).then(function(a) {
        a = json(a);
        for (var b = [], c, e = 0; e < a.length; e++)
            $("#masseneingabeInputIMw").append("<div data-row='" + (e + 1) + "'>" + inputString + "</div>"),
            ME.getModusEngOrBde() == InstanceMode.ENERGY ? (nameString += "<input name='" + (e + 1) + "' readonly style='display:inline-block;width:140px;background-color: transparent;border-color: transparent;' value='" + a[e].nameMSt + "'/><br>",
            b.push(new MeasurementPoint(a[e].mst_ID,a[e].nameMSt,nMonth))) : ME.getModusEngOrBde() == InstanceMode.BDE && (c = $("#btnAnlagenNummerMassEing").is(":checked") ? a[e].nummerAnl : a[e].bezeichnungAnl,
            nameString += "<input name='" + (e + 1) + "' readonly style='display:inline-block;width:140px;background-color: transparent;border-color: transparent;' value='" + c + "'/><br>",
            b.push(new Machine(a[e].anl_ID,c,nMonth)));
        $("#masseneingabeNameIMw").append(nameString);
        ME.setMeasurementObjects(b)
    })
}
function masseneingabeJahreEinlesen(a) {
    ME.resetObj();
    ...
    $("#masseneingabeZeitintervallIMw label, #masseneingabeZeitintervallIMw br, #masseneingabeNameIMw input, #masseneingabeNameIMw br, #masseneingabeInputIMw input, #masseneingabeInputIMw div, #masseneingabeInputIMw br").remove();
    for (var f = 0; 16 > f; f++)
        b = "<label style='display:inline-block;width:120px;'>" + (2010 + f) + "</label>",
        e += "<input name='" + (f + 1) + "' style='display:inline-block;width:116px;' />",
        $("#masseneingabeZeitintervallIMw").append(b);
    $("#masseneingabeZeitintervallIMw").append("<br>");
    a == InstanceMode.ENERGY ? g = "SELECT masseneingabeJahre.mst_ID, nameMSt FROM masseneingabeJahre INNER JOIN messstellen ON masseneingabeJahre.mst_ID = messstellen.mst_ID " : a == InstanceMode.BDE && (g = "SELECT masseneingabeJahre.anl_ID, bezeichnungAnl, nummerAnl FROM masseneingabeJahre INNER JOIN anlagen ON masseneingabeJahre.anl_ID = anlagen.anl_ID " + ("WHERE einheit = '" + $("#einheitMasseneingabeIMw").val() + "' "));
    (new DataMachine).runQuery("read", $("#nameDB").val(), g).then(function(a) {
        a = json(a);
        for (var b = [], f, g = 0; g < a.length; g++)
            $("#masseneingabeInputIMw").append("<div data-row='" + (g + 1) + "'>" + e + "</div>"),
            ME.getModusEngOrBde() == InstanceMode.ENERGY ? (c += "<input name='" + (g + 1) + "' readonly style='display:inline-block;width:140px;background-color: transparent;border-color: transparent;' value='" + a[g].nameMSt + "'/><br>",
            b.push(new MeasurementPoint(a[g].mst_ID,a[g].nameMSt,16))) : ME.getModusEngOrBde() == InstanceMode.BDE && (f = $("#btnAnlagenNummerMassEing").is(":checked") ? a[g].nummerAnl : a[g].bezeichnungAnl,
            c += "<input name='" + (g + 1) + "' readonly style='display:inline-block;width:140px;background-color: transparent;border-color: transparent;' value='" + f + "'/><br>",
            b.push(new Machine(a[g].anl_ID,f,16)));
        $("#masseneingabeNameIMw").append(c);
        ME.setMeasurementObjects(b)
    })
}
function mstOderAnlOhneZeitzuordnungInTbl(a) {
    var b = null
      , e = new DataMachine
      , c = void 0
      , g = []
    ...
    case InstanceMode.BDE:
        b = tblAnlOhneZeitintervallIMw,
        mstOrAnlString = "tblAnlOhneZeitintervallIMw",
        r = ReadInstance.INTERNE_BETRIEBSDATEN,
        c = "anlagen\n",
        g = ["anl_ID", "nummerAnl", "bezeichnungAnl", "messwertIMwAnl", "einheitIMwAnl"],
        f = "zeitintervallAnl"
    }
    b.clear().draw();
    ...
    e.runQuery("read", $("#nameDB").val(), q).then(function(a) {
        ...
        for (var c = a.length, e = 0; e < c; e++)
            b.row.add([e, a[e][g[0]], a[e][g[1]], a[e][g[2]], a[e][g[3]], a[e][g[4]]]).draw(),
            b.column(0).visible(!1).draw();
...
function masseneingabeInMonatNavigieren(a) {
...
function masseneingabeZeitintervallAendern(a) {
    ME.resetObj();
    var b = void 0;
    ...
    eingabeMaskeMasseneingabeInterneMesswerte(b, a)
}
function XOR(a, b) {
    return (a || b) && !(a && b)
}
function writeFormulaToDB(a) {
    var b = a.berechneteMstID
      , e = a.bezug
      , c = a.formelString
      , g = a.idString
      , f = {}
      , f = "Berechnung" === a.modus ? {
        id: "frm",
        berechneteMstID: b,
        formelString: c,
        idString: g
...
function writeVorlFormulaToDB(a, b, e) {
    $.ajax({
        type: "POST",
        async: !0,
        url: "php/instanzIntoDB.php",
...
function verbrauchsdatenExportieren() {
    var a = new DataMachine
      ...
      , f = 0;
    "001_heco" == b || "002_badber" == b || "003_tauchzor" == b ? (b = "SELECT nameMSt AS Name, CONVERT(varchar(20), time_de, 104) + ' ' + CONVERT(varchar(20), time_de, 108) AS Time, value AS Value FROM data_value_15m INNER JOIN messmittel ON data_value_15m.channel_id = messmittel.kanal1Msm INNER JOIN messstellen ON messmittel.mst_ID = messstellen.mst_ID " + ("WHERE messstellen.mst_ID = '" + e + "' ") + ("AND LEFT(CONVERT(varchar(20), time_de, 120), 4) = '" + c + "' "),
    "-" != g && (b += "AND RIGHT(LEFT(CONVERT(varchar(20), time_de, 120), 7), 2) = '" + g + "' "),
    b += "ORDER by time_de ",
    f = 1) : (b = "SELECT nameMSt AS Name, CONVERT(varchar(20), time_de, 104) + ' ' + CONVERT(varchar(20), time_de, 108) AS Time, phase AS Phase, power AS Value FROM data_value_15m INNER JOIN channel ON data_value_15m.channel_id = channel.channel_id INNER JOIN messmittel ON data_value_15m.channel_id = messmittel.kanal1Msm OR data_value_15m.channel_id = messmittel.kanal2Msm OR data_value_15m.channel_id = messmittel.kanal3Msm INNER JOIN messstellen ON messmittel.mst_ID = messstellen.mst_ID " + ("WHERE messstellen.mst_ID = '" + e + "' ") + ("AND LEFT(CONVERT(varchar(20), time_de, 120), 4) = '" + c + "' "),
    "-" != g && (b += "AND RIGHT(LEFT(CONVERT(varchar(20), time_de, 120), 7), 2) = '" + g + "' "),
    b += "ORDER by time_de ",
    f = 2);
    a.runQuery("read", $("#nameDB").val(), b).then(function(a) {
        ...
        for (var g = 0; g < b; g++)
            c = 1 == f ? 1 : a[g].Phase,
            e = $.isNumeric(a[g].Value) ? formatNumber("form", a[g].Value) : 0,
            tblVerbrauchsdatenExp.row.add([a[g].Name, a[g].Time, c, e]);
        tblVerbrauchsdatenExp.draw()
    })
}
function chartInNewWindow() {
    var a = ""
      , b = ""
      , e = ""
      , a = $("#nameDB").val()
    ...
    if ("" != h) {
        a = "SELECT nameMSt AS Name, CONVERT(varchar(20), time_de, 104) + ' ' + CONVERT(varchar(20), time_de, 108) AS Time, phase AS Phase," + c + " AS Value, wandlungsfaktorMsm AS ConvFactor FROM data_value_15m INNER JOIN channel ON data_value_15m.channel_id = channel.channel_id ";
        ...
        if ("Benutzerdefinierter Zeitraum" == $("#btnZeitrmDiag").text())
            if (a += "AND LEFT(CONVERT(varchar(20), time_de, 120), 4) = '" + u + "' ",
            "Tag" == p || "Tag 15min" == p)
                a += "AND RIGHT(LEFT(CONVERT(varchar(20), time_de, 120), 7), 2) = '" + t + "' ",
                a += "AND RIGHT(LEFT(CONVERT(varchar(20), time_de, 120), 10), 2) = '" + w + "' ";
            else {
                if ("Monat" == p || "Monat 15min" == p)
                    a += "AND RIGHT(LEFT(CONVERT(varchar(20), time_de, 120), 7), 2) = '" + t + "' "
            }
        else
            a += "AND time_de BETWEEN '" + transformDate(y) + "' AND '" + transformDate(z) + "' ";
        a += "ORDER by time_de ";
        b = "SELECT nameMSt AS Name, CONVERT(varchar(20), time_de, 104) + ' ' + CONVERT(varchar(20), time_de, 108) AS Time, phase AS Phase, " + c + " AS Value, wandlungsfaktorMsm AS ConvFactor FROM data_value_15m INNER JOIN channel ON data_value_15m.channel_id = channel.channel_id ";
        ...
        if ("Benutzerdefinierter Zeitraum" == $("#btnZeitrmDiag").text())
            if (b += "AND LEFT(CONVERT(varchar(20), time_de, 120), 4) = '" + u + "' ",
            "Tag" == p || "Tag 15min" == p)
                b += "AND RIGHT(LEFT(CONVERT(varchar(20), time_de, 120), 7), 2) = '" + t + "' ",
                b += "AND RIGHT(LEFT(CONVERT(varchar(20), time_de, 120), 10), 2) = '" + w + "' ";
            else {
                if ("Monat" == p || "Monat 15min" == p)
                    b += "AND RIGHT(LEFT(CONVERT(varchar(20), time_de, 120), 7), 2) = '" + t + "' "
            }
        else
            b += "AND time_de BETWEEN '" + transformDate(y) + "' AND '" + transformDate(z) + "' ";
        b += "ORDER by time_de ";
        e = "SELECT nameMSt AS Name, CONVERT(varchar(20), time_de, 104) + ' ' + CONVERT(varchar(20), time_de, 108) AS Time, phase AS Phase, " + c + " AS Value, wandlungsfaktorMsm AS ConvFactor FROM data_value_15m INNER JOIN channel ON data_value_15m.channel_id = channel.channel_id ";
        ...
        if ("Benutzerdefinierter Zeitraum" == $("#btnZeitrmDiag").text())
            if (e += "AND LEFT(CONVERT(varchar(20), time_de, 120), 4) = '" + u + "' ",
            "Tag" == p || "Tag 15min" == p)
                e += "AND RIGHT(LEFT(CONVERT(varchar(20), time_de, 120), 7), 2) = '" + t + "' ",
                e += "AND RIGHT(LEFT(CONVERT(varchar(20), time_de, 120), 10), 2) = '" + w + "' ";
            else {
                if ("Monat" == p || "Monat 15min" == p)
                    e += "AND RIGHT(LEFT(CONVERT(varchar(20), time_de, 120), 7), 2) = '" + t + "' "
            }
        else
            e += "AND time_de BETWEEN '" + transformDate(y) + "' AND '" + transformDate(z) + "' ";
        e += "ORDER by time_de "
    } else if ("" != f) {
        a = "SELECT nameMSt AS Name, CONVERT(varchar(20), time_de, 104) + ' ' + CONVERT(varchar(20), time_de, 108) AS Time, phase AS Phase, " + c + " AS Value, wandlungsfaktorMsm AS ConvFactor FROM data_value_15m INNER JOIN channel ON data_value_15m.channel_id = channel.channel_id ";
        a += "INNER JOIN messmittel ";
...
function gespeicherteDiagrammeAuswahllisteErstellen2() {
    var a = ""
      , b = ""
      , e = ""
      , a = $("#nameDB").val()
    ...
    if ("" != r) {
        a = "SELECT nameMSt AS Name, CONVERT(varchar(20), time_de, 104) + ' ' + CONVERT(varchar(20), time_de, 108) AS Time, phase AS Phase, " + f + " AS Value, wandlungsfaktorMsm AS ConvFactor FROM data_value_15m INNER JOIN channel ON data_value_15m.channel_id = channel.channel_id ";
        a += "INNER JOIN messmittel ";
        a += "ON data_value_15m.channel_id = messmittel.kanal1Msm OR data_value_15m.channel_id = messmittel.kanal2Msm OR data_value_15m.channel_id = messmittel.kanal3Msm ";
        a += "INNER JOIN messstellen ";
        a += "ON messmittel.mst_ID = messstellen.mst_ID ";
        ...
        if ("Benutzerdefinierter Zeitraum" == $("#btnZeitrmDiag").text())
            if (a += "AND LEFT(CONVERT(varchar(20), time_de, 120), 4) = '" + h + "' ",
            "Tag" == v || "Tag 15min" == v)
                a += "AND RIGHT(LEFT(CONVERT(varchar(20), time_de, 120), 7), 2) = '" + x + "' ",
                a += "AND RIGHT(LEFT(CONVERT(varchar(20), time_de, 120), 10), 2) = '" + w + "' ";
            else {
                if ("Monat" == v || "Monat 15min" == v)
                    a += "AND RIGHT(LEFT(CONVERT(varchar(20), time_de, 120), 7), 2) = '" + x + "' "
            }
        else
            a += "AND time_de BETWEEN '" + transformDate(C) + "' AND '" + transformDate(D) + "' ";
        a += "ORDER by time_de ";
        b = "SELECT nameMSt AS Name, CONVERT(varchar(20), time_de, 104) + ' ' + CONVERT(varchar(20), time_de, 108) AS Time, phase AS Phase, " + f + " AS Value, wandlungsfaktorMsm AS ConvFactor FROM data_value_15m INNER JOIN channel ON data_value_15m.channel_id = channel.channel_id ";
        b += "INNER JOIN messmittel ";
        b += "ON data_value_15m.channel_id = messmittel.kanal1Msm OR data_value_15m.channel_id = messmittel.kanal2Msm OR data_value_15m.channel_id = messmittel.kanal3Msm ";
        b += "INNER JOIN messstellen ";
        b += "ON messmittel.mst_ID = messstellen.mst_ID ";
        ...
        if ("Benutzerdefinierter Zeitraum" == $("#btnZeitrmDiag").text())
            if (b += "AND LEFT(CONVERT(varchar(20), time_de, 120), 4) = '" + q + "' ",
            "Tag" == v || "Tag 15min" == v)
                b += "AND RIGHT(LEFT(CONVERT(varchar(20), time_de, 120), 7), 2) = '" + u + "' ",
                b += "AND RIGHT(LEFT(CONVERT(varchar(20), time_de, 120), 10), 2) = '" + y + "' ";
            else {
                if ("Monat" == v || "Monat 15min" == v)
                    b += "AND RIGHT(LEFT(CONVERT(varchar(20), time_de, 120), 7), 2) = '" + u + "' "
            }
        else
            b += "AND time_de BETWEEN '" + transformDate(C) + "' AND '" + transformDate(D) + "' ";
        b += "ORDER by time_de ";
        e = "SELECT nameMSt AS Name, CONVERT(varchar(20), time_de, 104) + ' ' + CONVERT(varchar(20), time_de, 108) AS Time, phase AS Phase, " + f + " AS Value, wandlungsfaktorMsm AS ConvFactor FROM data_value_15m INNER JOIN channel ON data_value_15m.channel_id = channel.channel_id ";
        e += "INNER JOIN messmittel ";
        e += "ON data_value_15m.channel_id = messmittel.kanal1Msm OR data_value_15m.channel_id = messmittel.kanal2Msm OR data_value_15m.channel_id = messmittel.kanal3Msm ";
        e += "INNER JOIN messstellen ";
        e += "ON messmittel.mst_ID = messstellen.mst_ID ";
        ...
        if ("Benutzerdefinierter Zeitraum" == $("#btnZeitrmDiag").text())
            if (e += "AND LEFT(CONVERT(varchar(20), time_de, 120), 4) = '" + r + "' ",
            "Tag" == v || "Tag 15min" == v)
                e += "AND RIGHT(LEFT(CONVERT(varchar(20), time_de, 120), 7), 2) = '" + t + "' ",
                e += "AND RIGHT(LEFT(CONVERT(varchar(20), time_de, 120), 10), 2) = '" + z + "' ";
            else {
                if ("Monat" == v || "Monat 15min" == v)
                    e += "AND RIGHT(LEFT(CONVERT(varchar(20), time_de, 120), 7), 2) = '" + t + "' "
            }
        else
            e += "AND time_de BETWEEN '" + transformDate(C) + "' AND '" + transformDate(D) + "' ";
        e += "ORDER by time_de "
    } else if ("" != q) {
        a = "SELECT nameMSt AS Name, CONVERT(varchar(20), time_de, 104) + ' ' + CONVERT(varchar(20), time_de, 108) AS Time, phase AS Phase, " + f + " AS Value, wandlungsfaktorMsm AS ConvFactor FROM data_value_15m INNER JOIN channel ON data_value_15m.channel_id = channel.channel_id ";
        a += "INNER JOIN messmittel ";
        ...
        a = "SELECT nameMSt AS Name, CONVERT(varchar(20), time_de, 104) + ' ' + CONVERT(varchar(20), time_de, 108) AS Time, phase AS Phase, " + f + " AS Value FROM data_value_15m INNER JOIN channel ON data_value_15m.channel_id = channel.channel_id ";
        a += "INNER JOIN messmittel ";
        a += "ON data_value_15m.channel_id = messmittel.kanal1Msm OR data_value_15m.channel_id = messmittel.kanal2Msm OR data_value_15m.channel_id = messmittel.kanal3Msm ";
        a += "INNER JOIN messstellen ";
        a += "ON messmittel.mst_ID = messstellen.mst_ID ";
...
function mkDpCp(a, b) {
    ...
    if (a == ObjectCopyMode.SHALLOW || ObjectCopyMode.DEEP)
        g = $.extend(e, {}, b[0]);
...
var set = id
  , isInstance = function(a) {
    return head(["First", "Next", "Previous", "Last"].map(flip(splt)(a)).filter(function(a) {
        return 1 < len(a)
    }).join().split(","))
}
...
function spiesOrganisationenSearch() {    
    ...
    $.ajax({
        ...
        success: function(e) {
            ...
            e = json(e);
            //console.log(e);
            spiesOrganisationenSearch1.colReorder.reset();
            spiesOrganisationenSearch1.clear().draw();
            for (var c = 0; c < e.length; c++){
                spiesOrganisationenSearch1.row.add([
                    e[c].nameOrg,
                    e[c].anschriftOrg,
                    e[c].landOrg,                      
                    e[c].org_ID
            ...
            $("#spiesOrganisationenSearchContainer").dialog({
                ...
                open: function() {
                    ...
                    $("#tblAnlagenListe2 tbody").on("dblclick", "tr", function() {
                        ...
                        $("#inpAuswahlVorlFrmIns" + b).val(e),
                        $("#inpAuswahlVorlFrmIDIns" + b).val(c));
                        $("#spiesOrganisationenSearchContainer").dialog("close")
                    })*/
                }
            })
        }
