    ...
    render(){
        return(
            <div className="app-header">
                ...
                <span className="header-text">Spread Sheets React Sample</span>
            </div>
        )
    }
}
    ...
    render(){
        return(
            <div className="app-footer">
                <span className="footer-text">© 2019GrapeCity, inc. All Rights Reserved. All product and company names herein may be trademarks of their respective owners.</span>
            </div>
        )
    }
}
