                ...
                if(zeitintervallAnl == 1){
                    ...
                    for (var e = 0; e < b; e++){
                        if(e==0) {
                            ...
                            for (var r = 0; r <= days; r++){
                                ...
                                $row += '<th data-id="'+a.query1[e].anl_id+'" class="masseneingabeInputLBL">'+convertToDateMonthAndYearformate(dateArr[r])+'</th>';
                    ...
                    for (var e = 0; e < b; e++){
                        ...
                        for (var r = 0; r <= days; r++){
                            ...
                            var inputVal = findArrValueByDatePrdkt(dateArr[r],a.query1[e].anl_id,a.query2);
                            $row += '<td data-id="'+a.query1[e].anl_id+'"  date="'+dateArr[r]+'" class="masseneingabeInputTD"><input type="text" class="txtBoxSrch isShowPopup '+z+'" id="anlageMainRow_'+r+'"  name="masseneingabeInput'+r+'[]" '+n+' value="'+inputVal+'"/></td>';
                            if(inputVal !=''){
                                datesOfArr.push(dateArr[r]);
                        ...
                        for (var r = 0; r <= days; r++){
                            ...
                            var inputVal = findArrValueByDatePrdkt(dateArr[r],a.query1[e].anl_id,a.query3);
                            // <--5-7-2021--- If else add
                            if(rdOnly == 'readonly' && countInvest == 0){
                                $row += '<td data-id="'+a.query1[e].anl_id+'"  date="'+dateArr[r]+'" class="masseneingabeInputTD"><input type="text" id="anlageCalculationRow_'+r+'" name="masseneingabeInput'+r+'[]" '+n+' '+rdOnly+' placeholder="'+min_val+'-'+max_val+'" value="'+inputVal+'"/></td>';
                                countInvest = 1;
                            }else{
                                $row += '<td data-id="'+a.query1[e].anl_id+'"  date="'+dateArr[r]+'" class="masseneingabeInputTD"><input type="text" id="anlageCalculationRow_'+r+'" name="masseneingabeInput'+r+'[]" '+n+' '+rdOnly+' value="'+inputVal+'"/></td>';    
                            }
                        }
                        $row += '</tr>';
                    }
                        ...
                        if(e==0) {
                            ...
                            for (var r = 0; r <= years; r++){
                                ...
                                for (var i = g; i <= weekNum; i++){
                                    ...
                                    $row += '<th data-id="'+a.query1[e].anl_id+'" class="masseneingabeInputLBL">' + i + ' KW ' + yr + '</th>';
                                    if(i>=53){
                                        var g=1;
                                    }
                                }
                    ...
                    for (var e = 0; e < b; e++){
                        ...
                        for (var r1 = 0; r1 <= years; r1++){
                            ...
                            for (var i1 = g1; i1 <= weekNum; i1++){
                                ...
                                var inputVal =  findArrValueByDateWeekPrdkt(yr1,i1,a.query1[e].anl_id,a.query2);
                                $row += '<td data-id="'+a.query1[e].anl_id+'" class="masseneingabeInputTD" date="' + i1 + '-' + yr1 + '"><input type="text" id="anlageMainRow_'+count1+'" name="masseneingabeInput'+i1+'[]" '+m+' class="txtBoxSrch isShowPopup" value="'+inputVal+'"/></td>';
                                if(i1>=53){
                                    var g1=1;
                                    // console.log('i1='+i1);
                                }
                        ...
                        for (var r2 = 0; r2 <= years; r2++){
                            ...
                            for (var i2 = g2; i2 <= weekNum; i2++){
                                ...
                                var inputVal =  findArrValueByDateWeekPrdkt(yr2,i2,a.query1[e].anl_id,a.query3);
                                if(rdOnly == 'readonly' && countInvest == 0){
                                    $row += '<td data-id="'+a.query1[e].anl_id+'" class="masseneingabeInputTD"  date="' + i2 + '-' + yr2 + '"><input type="text" id="anlageCalculationRow_'+count2+'" name="masseneingabeInput'+i2+'[]" '+m+' '+rdOnly+' placeholder="'+min_val+'-'+max_val+'" value="'+inputVal+'"/></td>';
                                    countInvest = 1;
                                }
                                else{
                                    $row += '<td data-id="'+a.query1[e].anl_id+'" class="masseneingabeInputTD"  date="' + i2 + '-' + yr2 + '"><input type="text" id="anlageCalculationRow_'+count2+'" name="masseneingabeInput'+i2+'[]" '+m+' '+rdOnly+' value="'+inputVal+'"/></td>';
                                }
                    ...
                    for (var e = 0; e < b; e++){
                        if(e==0) {
                            $row += '<tr><th style="position: sticky;top: 0;background-color: #dddddd;">Anlage</th>';
                            for (var r = 0; r <= months; r++){
                                $row += '<th data-id="'+a.query1[e].anl_id+'" class="masseneingabeInputLBL">' + convertToMonthAndYearformate(dateArr[r]) + '</th>';
                            }
                            $row += '</tr>';
                        }
                    }
                    ...
                    for (var e = 0; e < b; e++){
                        ...
                        for (var r = 0; r <= months; r++){
                            ...
                            var inputVal = findArrValueByDatePrdkt(dateArr[r],a.query1[e].anl_id,a.query2);
                            $row += '<td data-id="'+a.query1[e].anl_id+'" class="masseneingabeInputTD" date="' + dateArr[r] + '"><input type="text" name="masseneingabeInput'+r+'[]" '+n+' class="txtBoxSrch isShowPopup" id="anlageMainRow_'+r+'" value="'+inputVal+'" /></td>';
                            if(inputVal !=''){
                                monthOfArr.push(dateArr[r]);
                        ...
                        for (var r = 0; r <= months; r++){
                            ...
                            var inputVal = findArrValueByDatePrdkt(dateArr[r],a.query1[e].anl_id,a.query3);
                            if(rdOnly == 'readonly' && countInvest == 0){
                                $row += '<td data-id="'+a.query1[e].anl_id+'" class="masseneingabeInputTD" date="' + dateArr[r] + '"><input type="text" name="masseneingabeInput'+r+'[]" '+n+' '+rdOnly+' id="anlageCalculationRow_'+r+'" placeholder="'+min_val+'-'+max_val+'" value="'+inputVal+'"/></td>';
                                countInvest = 1;
                            }
                            else{
                                $row += '<td data-id="'+a.query1[e].anl_id+'" class="masseneingabeInputTD" date="' + dateArr[r] + '"><input type="text" name="masseneingabeInput'+r+'[]" '+n+' '+rdOnly+' id="anlageCalculationRow_'+r+'" value="'+inputVal+'"/></td>';
                            }
                    ...
                    for (var e = 0; e < b; e++){
                        if(e==0) {
                            ...
                            for (var r = 0; r <= years; r++){
                                var yr = eval(startDate) + eval(r);
                                $row += '<th data-id="'+a.query1[e].anl_id+'" class="masseneingabeInputLBL">' + yr + '</th>';
                            }
                            $row += '</tr>';
                        }
                    }
                    ...
                    for (var e = 0; e < b; e++){
                        ...
                        for (var r = 0; r <= years; r++){
                            ...
                            var inputVal = findArrValueByDatePrdkt(yearsBw[r],a.query1[e].anl_id,a.query2);
                            $row += '<td data-id="'+a.query1[e].anl_id+'" class="masseneingabeInputTD" date="' + yr1 + '"><input type="text" name="masseneingabeInput'+r+'[]" '+t+' class="txtBoxSrch isShowPopup" id="anlageMainRow_'+r+'" value="'+inputVal+'" /></td>';
                            if(inputVal !=''){
                                yearOfArr.push(String(yearsBw[r]));
                        ...
                        for (var r = 0; r <= years; r++){
                            ...
                            var inputVal = findArrValueByDatePrdkt(yearsBw[r],a.query1[e].anl_id,a.query3);
                            if(rdOnly == 'readonly' && countInvest == 0){
                                $row += '<td data-id="'+a.query1[e].anl_id+'" class="masseneingabeInputTD" date="' + yr1 + '"><input type="text" name="masseneingabeInput'+r+'[]" '+t+' '+rdOnly+'  id="anlageCalculationRow_'+r+'" placeholder="'+min_val+'-'+max_val+'" value="'+inputVal+'"/></td>';
                                countInvest = 1;
                            }
                            else{
                                $row += '<td data-id="'+a.query1[e].anl_id+'" class="masseneingabeInputTD" date="' + yr1 + '"><input type="text" name="masseneingabeInput'+r+'[]" '+t+' '+rdOnly+'  id="anlageCalculationRow_'+r+'" value="'+inputVal+'"/></td>';
                            }
