...
return c},"es6-impl","es3");function DataMachine(){this.filter=this.data=this.originalData=null;this.query=""}DataMachine.prototype.runQuery=function(a,d,e){return performAjaxCall(a,d,e)};
function performAjaxCall(a,d,e){var c=loadingOverlay.activate();return new Promise(function(g,b){$.ajax({type:"POST",async:!0,url:"php/queryData.php",data:{nameDB:d,mode:a,liegID:$("#liegID").val(),query:e},success:function(a){0<a.length?(loadingOverlay.cancel(c),g(a)):b("Ajax Call failed!No data has been returned.")}})})};
