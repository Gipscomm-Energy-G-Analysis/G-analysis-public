...
this.batch_;this.batch_=[];for(var f=0;f<b.length;++f){var a=b[f];delete b[f];try{a()}catch(k){this.asyncThrow_(k)}}}this.batch_=null};d.prototype.asyncThrow_=function(b){this.asyncExecuteFunction(function(){throw b;})};var c=function(b){this.state_=0;this.result_=void 0;this.onSettledCallbacks_=[];var a=this.createResolveAndReject_();try{b(a.resolve,a.reject)}catch(h){a.reject(h)}};c.prototype.createResolveAndReject_=function(){function b(b){return function(f){c||(c=!0,b.call(a,f))}}var a=this,c=
...
return c},"es6-impl","es3");function DataMachine(){this.filter=this.data=this.originalData=null;this.query=""}DataMachine.prototype.runQuery=function(a,d,e){return performAjaxCall(a,d,e)};function performAjaxCall(a,d,e){return new Promise(function(c,g){$.ajax({type:"POST",async:!0,url:"php/queryData.php",data:{nameDB:d,mode:a,liegID:$("#liegID").val(),query:e},success:function(a){0<a.length?c(a):g("Ajax Call failed!No data has been returned.")}})})};
